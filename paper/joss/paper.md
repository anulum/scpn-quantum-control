...
Generative AI tools assisted with parts of software drafting,
benchmark-harness scaffolding, and manuscript editing.  All numerical claims
were verified against committed JSON/CSV artefacts and the corresponding
benchmark scripts.  Scientific framing, claim boundaries, authorship decisions,
and final responsibility for the manuscript remain with the author.
