...
erase the dominant DLA-channel discrepancy. The result is a
...
control partially improves. The present paper therefore remains narrow but
stronger: it reports structured mechanism-boundary evidence that survives
readout replay, second-backend replication, pinned-layout repetition, and a
