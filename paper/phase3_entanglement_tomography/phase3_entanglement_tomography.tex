...
\texttt{ibm\_fez} qubits $[21,22,23,24]$: \texttt{dla\_odd\_signal}
\texttt{XXII}/\texttt{YYII}, \texttt{dla\_odd\_shallow}
\texttt{IIXX}/\texttt{IIYY}, and the \texttt{fim\_lambda4\_feedback}
\texttt{IZZI} control; three repetitions; global unitary-folding scale
factors $1,3,5$; and all 16 readout-calibration states. Under an explicit ZNE
depth gate of 1900, the maximum transpiled depth is 1705 and the estimated QPU
time is 0.56 minutes.
