...
# GOTM-SCPN Paper 2: Layer 2 - Neurochemical-Neurological

This package is reserved for the tuned Paper 2 extraction and validation
...
- `validation_protocols/` - protocols for testing Paper 2 claims.
