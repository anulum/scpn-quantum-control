...
magnetisation-leakage deltas remained positive: $+0.0599$ on Marrakesh and
$+0.1937$ on Fez. Thus the tested digital Trotter implementation falsifies the
simple hypothesis that this FIM term acts as a hardware coherence-protection
mechanism. The paper is deliberately bounded: the artefacts support exact
...
replication FIM follow-ups because they include all 16 readout baseline
