...
| `rust_program_ad_ir` | `rust_backed` | `partial` | `partial` | `not_run` | reverse-mode value+gradient replay is not complete<br>executed branch replay and array adjoints are missing |
