...
| `rust_program_ad_ir` | `rust_backed` | `partial` | `partial` | `functional_non_isolated` | executed branch replay, primitive-family replay, and array adjoints are missing<br>registry metadata mirror, LLVM/JIT lowering, and isolated benchmark evidence are missing |
