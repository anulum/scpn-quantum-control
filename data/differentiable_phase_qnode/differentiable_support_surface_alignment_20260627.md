...
- Artifact ID: `diff-support-surface-alignment-audit-v1`
- `passed`: `True`
- Claim boundary: support-surface alignment audit only; verifies claim-ledger paths against the generated capability manifest without promoting differentiable performance, hardware, or provider claims
