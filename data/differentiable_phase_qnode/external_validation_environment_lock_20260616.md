...
|---|---|---|---|
| `pyproject.toml` | Package metadata and bounded dependency ranges | `c3fb3264c39bf54a6a8117d4bda40ca1c21c9f6d9a4e0336493a2633eb2385bb` | 0 |
...
| `requirements-ci-py311-linux.txt` | Python 3.11 Linux CI lockfile | `030de97aea281cc0a1ce39b926405ef6eaf7199cbc8836844c944fb69496969d` | 156 |
| `requirements-ci-py312-linux.txt` | Python 3.12 Linux CI lockfile | `c906ca45454a9e8f32896fb8de0b3c670f0b7bdcd4104c1e4651f5e15a0d8782` | 156 |
| `requirements-ci-py313-linux.txt` | Python 3.13 Linux CI lockfile | `1d0418b8ace9de61956421784f37d2b35938733b0dd518d149ad8abdbf8bb077` | 156 |
