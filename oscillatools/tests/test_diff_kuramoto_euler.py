...
# oscillatools — Differentiable networked-Kuramoto Euler integrator and adjoint tests
...
import oscillatools.accel.diff_kuramoto_euler as dk
...
class TestTiersAndDispatch:
    ...
    def test_julia_matches_python_floor(self) -> None:
        ...
        from oscillatools.accel.julia import kuramoto_euler_vjp as julia_vjp
