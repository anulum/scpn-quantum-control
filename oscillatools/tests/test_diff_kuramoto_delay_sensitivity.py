...
# oscillatools — Tests for the time-delayed Kuramoto delay sensitivity dtheta_N/dtau
...
:func:`~oscillatools.accel.kuramoto_delayed.integrate_delayed_kuramoto` evaluated at an
