...
# oscillatools — Differentiable networked-Kuramoto RK4 integrator and adjoint tests
...
import oscillatools.accel.diff_kuramoto_rk4 as rk
...
class TestTiersAndDispatch:
    ...
    def test_julia_matches_python_floor(self) -> None:
        ...
        from oscillatools.accel.julia import kuramoto_rk4_trajectory as julia_traj
        from oscillatools.accel.julia import kuramoto_rk4_vjp as julia_vjp
