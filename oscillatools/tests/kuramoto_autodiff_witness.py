...
:mod:`~oscillatools.accel.diff_kuramoto_rk4`,
:mod:`~oscillatools.accel.diff_kuramoto_dopri`,
:mod:`~oscillatools.accel.diff_kuramoto_adaptive`,
:mod:`~oscillatools.accel.diff_kuramoto_delayed`,
:mod:`~oscillatools.accel.diff_kuramoto_inertial`,
:mod:`~oscillatools.accel.diff_kuramoto_noisy` and
:mod:`~oscillatools.accel.kuramoto_ott_antonsen` all validate their
...
def _force(theta: Array, coupling: Array) -> Array:
    ...
    Mirrors :func:`oscillatools.accel.networked_kuramoto.networked_kuramoto_force`
...
def delayed_terminal(
    ...
    Mirrors :func:`oscillatools.accel.diff_kuramoto_delayed.delayed_phase_sensitivity`:
...
def frozen_noise_increments(seed: int, n_steps: int, count: int) -> NDArray[np.float64]:
    ...
    same order as :func:`oscillatools.accel.diff_kuramoto_noisy.noisy_phase_sensitivity`,
...
def ott_antonsen_terminal_radius(
    ...
    :func:`oscillatools.accel.kuramoto_ott_antonsen.ott_antonsen_terminal_order_parameter_value_and_grad`,
