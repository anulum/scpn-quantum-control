...
r"""Tests for :mod:`oscillatools.accel.kuramoto_heterogeneous`.
...
from oscillatools.accel.kuramoto_heterogeneous import (
    CouplingTerm,
    heterogeneous_force,
...
from oscillatools.accel.kuramoto_hyperedge import hyperedge_force, hyperedge_jacobian
from oscillatools.accel.kuramoto_simplex_mean_field import (
    simplex_mean_field_force,
    simplex_mean_field_jacobian,
)
from oscillatools.accel.networked_kuramoto import (
...
def test_components_match_individual_terms() -> None:
    ...
    terms = _mixed_terms(coupling)
    components = heterogeneous_force_components(theta, terms)
    for term, contribution in zip(terms, components, strict=True):
