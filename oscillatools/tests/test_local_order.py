...
# oscillatools — Network-local Kuramoto order parameter and Jacobian tests
...
import oscillatools.accel.local_order as lo
import oscillatools.accel.order_parameter_observables as op
...
class TestJuliaLocalOrderTier:
    def test_julia_matches_python_floor(self) -> None:
        ...
        from oscillatools.accel.julia import local_order_parameter as julia_value
