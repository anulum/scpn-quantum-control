...
# oscillatools — Daido m-th-harmonic mean-field force and Jacobian tests
...
import oscillatools.accel.daido_mean_field as dmf
...
class TestDaidoMeanFieldTiersAndDispatch:
    ...
    def test_julia_matches_python_floor(self) -> None:
        ...
        from oscillatools.accel.julia import daido_mean_field_force as julia_force
