...
:func:`~oscillatools.accel.kuramoto_network_control.integrate_controlled_network`.

The control convention is the additive per-oscillator drive of
:mod:`~oscillatools.accel.kuramoto_network_control`:
...
:func:`~oscillatools.accel.kuramoto_network_control.network_control_value_and_grad`, so the JAX
...
def _load_backend() -> _MpcBackend:
    ...
    try:
        ...
        raise ImportError("the JAX MPC tier requires JAX; install oscillatools[jax]") from error
...
def jax_mpc_control_value_and_grad(
    ...
    *,
    ...
    :func:`~oscillatools.accel.kuramoto_network_control.network_control_value_and_grad`, whose
...
def receding_horizon_control(
    ...
    *,
    ...
    :func:`~oscillatools.accel.kuramoto_network_control.integrate_controlled_network` with
