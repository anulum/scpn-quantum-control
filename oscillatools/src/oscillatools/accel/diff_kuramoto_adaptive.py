...
:func:`~oscillatools.accel.kuramoto_adaptive.integrate_adaptive_kuramoto` carried no
...
:func:`~oscillatools.accel.kuramoto_adaptive.hebbian_adaptive_jacobian` and the explicit
