...
* :func:`chimera_snapshot` — the per-community order parameters
  :func:`~oscillatools.accel.kuramoto_chimera.community_order_parameters` over time, annotated
  with the :func:`~oscillatools.accel.kuramoto_chimera.chimera_index`, to read a chimera state
...
module — and therefore the :mod:`oscillatools.accel` and :mod:`oscillatools`
...
def chimera_snapshot(
    ...
    *,
    ...
    Reuses :func:`~oscillatools.accel.kuramoto_chimera.community_order_parameters` and
    :func:`~oscillatools.accel.kuramoto_chimera.chimera_index`, so the rendered curves and the
