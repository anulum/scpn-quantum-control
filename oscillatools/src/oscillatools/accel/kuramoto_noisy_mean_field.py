...
:mod:`oscillatools.accel.kuramoto_critical_coupling` (reused for the ``D = 0`` limit), so
...
#: :mod:`oscillatools.accel.kuramoto_critical_coupling`).
...
def noisy_critical_coupling(
    ...
    *,
    ...
    :func:`~oscillatools.accel.kuramoto_critical_coupling.critical_coupling`).
...
def noisy_stationary_order_parameter(
    ...
    *,
    ...
    :func:`~oscillatools.accel.kuramoto_critical_coupling.synchronised_order_parameter` is
    used.
