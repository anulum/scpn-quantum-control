...
:func:`~oscillatools.accel.kuramoto_inertial.integrate_inertial` carried no gradient
...
with :math:`J(w)` the analytic :func:`~oscillatools.accel.kuramoto_inertial.inertial_jacobian`
