...
phase-coupling forces already shipped in :mod:`oscillatools.accel`
...
the second-order inertial model (:func:`~oscillatools.accel.kuramoto_inertial.integrate_inertial`,
state :math:`(\theta, v)`), the stochastic model
(:func:`~oscillatools.accel.kuramoto_noisy.integrate_noisy_kuramoto`),
the delay-differential model
(:func:`~oscillatools.accel.kuramoto_delayed.integrate_delayed_kuramoto`,
state is a history buffer), and the adaptive model
(:func:`~oscillatools.accel.kuramoto_adaptive.integrate_adaptive_kuramoto`,
