...
is to :mod:`~oscillatools.accel.daido_observables` what
:mod:`~oscillatools.accel.mean_phase_observables` is to
:mod:`~oscillatools.accel.order_parameter_observables`: the phase partner of the
...
def daido_mode_phase_gradient(theta: NDArray[np.float64], m: int) -> NDArray[np.float64]:
    ...
    :math:`m = 1` it equals
    :func:`~oscillatools.accel.mean_phase_observables.mean_phase_gradient`.
...
def daido_mode_phase_hessian(theta: NDArray[np.float64], m: int) -> NDArray[np.float64]:
    ...
    :func:`~oscillatools.accel.mean_phase_observables.mean_phase_hessian`.
