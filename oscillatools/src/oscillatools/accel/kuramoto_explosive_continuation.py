...
accelerated :func:`~oscillatools.accel.order_parameter_observables.order_parameter`, so the
...
#: :func:`~oscillatools.accel.kuramoto_mean_field.mean_field_force` and
#: :func:`~oscillatools.accel.triadic_mean_field.triadic_mean_field_force`).
