...
:mod:`oscillatools.accel.kuramoto_delayed_mean_field`; this module is the matching
...
the accelerated :func:`~oscillatools.accel.order_parameter_observables.order_parameter`,
