...
# oscillatools — Unified Kuramoto toolkit facade
r"""Unified import surface for the Kuramoto toolkit.

Every classical-Kuramoto capability lives in :mod:`oscillatools.accel` as a focused,
single-responsibility module. This facade re-exports that whole surface under one import so a
caller writes ``from oscillatools import order_parameter, kuramoto_rk4_trajectory,
...
:mod:`oscillatools.accel`, so the two surfaces stay in lock-step (a parity guarded by the
...
# toolkit. Its union is exactly ``oscillatools.accel.__all__`` (parity guarded by the
