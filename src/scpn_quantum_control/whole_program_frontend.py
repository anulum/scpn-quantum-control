...
# SCPN Quantum Control — whole program frontend module
...
This module builds no-execution compiler-frontend metadata for Python objectives:
bytecode rows, source regions, symbol scopes, semantic diagnostics, and deterministic
