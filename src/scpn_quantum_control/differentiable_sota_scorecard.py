...
def _default_scorecard_rows(
    ...
    row_specs = (
        ...
        _row(
            ...
            "for var/std, compact rank-1 signal convolve/correlate replay with static mode "
            ...
            "reduction adjoints, compact static-grid trapezoid reduction adjoints, and compact "
            "signal convolve/correlate replay; 2026-07-04 "
