...
def _default_scorecard_rows(
    ...
    row_specs = (
        ...
        _row(
            ...
            "Rust Program AD metadata parsing and bounded scalar forward interpretation exist; scalar "
            "value+gradient replay, branch replay, array adjoints, and registry mirror remain open.",
            ("phase_qnode_claim_boundary",),
            (
                "Rust scalar value+gradient Program AD replay is not complete",
