...
def _default_inventory_rows(
    ...
    rows = (
        ...
        _inventory_row(
            ...
            (
                "scpn_quantum_engine/program_ad_replay/src/program_ad_ir.rs",
                "scpn_quantum_engine/program_ad_replay/src/program_ad_trapezoid_reduction.rs",
                "scpn_quantum_engine/program_ad_replay/src/program_ad_interpolation_reduction.rs",
            ...
            (
                ...
                "tests/test_program_ad_rust_interpolation_bridge.py",
                "tests/test_program_ad_rust_signal_bridge.py",
                "tests/test_program_ad_rust_cumulative_bridge.py",
                "scpn_quantum_engine/tests/program_ad_interpolation.rs",
                "scpn_quantum_engine/tests/program_ad_signal.rs",
                "scpn_quantum_engine/tests/program_ad_stencil.rs",
                "scpn_quantum_engine/tests/program_ad_cumulative.rs",
        ...
        _inventory_row(
            ...
            "Differentiable baseline category scorecard",
            "metadata_only",
            ...
            ("docs/differentiable_api.md", "docs/differentiable_programming.md"),
            ("diff-baseline-scorecard-20260620",),
            ("differentiable_baseline_scorecard",),
            "not_applicable",
            "not_applicable",
            "not_applicable",
