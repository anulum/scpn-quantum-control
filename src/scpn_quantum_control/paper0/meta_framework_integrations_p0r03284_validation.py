...
SOURCE_LEDGER_SPAN = ("P0R03284", "P0R03294")


@dataclass(frozen=True, slots=True)
class MetaFrameworkIntegrationsP0r03284Config:
    """Configuration for this Paper 0 source-accounting fixture."""

    expected_source_record_count: int = 11
    expected_component_count: int = 4
    next_source_boundary: str = "P0R03295"
    ...
    def __post_init__(self) -> None:
        ...
        if self.next_source_boundary != "P0R03295":
            raise ValueError("next_source_boundary must equal P0R03295")


@dataclass(frozen=True, slots=True)
class MetaFrameworkIntegrationsP0r03284FixtureResult:
...
def classify_meta_framework_integrations_p0r03284_component(component: str) -> str:
    ...
    mapping = {
        ...
        "collapse_as_inference": "collapse_as_inference_source_boundary",
        "psis_field_coupling_integration": "psis_field_coupling_integration_source_boundary",
    }
    try:
        return mapping[component]
    except KeyError as exc:
        raise ValueError("unknown meta_framework_integrations_p0r03284 component") from exc


def meta_framework_integrations_p0r03284_labels() -> dict[str, str]:
    """Return source-bounded labels for this slice."""
    return {
        "section": "Meta-Framework Integrations",
        "source_span": "P0R03284-P0R03294",
        "component_count": "4",
        "next_boundary": "P0R03295",
        "component_1": "Meta-Framework Integrations",
        "component_2": "Predictive Coding Integration",
        "component_3": "Collapse as Inference:",
        "component_4": "Psis Field Coupling Integration",
    }


def validate_meta_framework_integrations_p0r03284_fixture(
    config: MetaFrameworkIntegrationsP0r03284Config | None = None,
) -> MetaFrameworkIntegrationsP0r03284FixtureResult:
    """Validate source accounting for this Paper 0 slice."""
    cfg = config or MetaFrameworkIntegrationsP0r03284Config()
    components = (
    ...
    return MetaFrameworkIntegrationsP0r03284FixtureResult(
        source_ledger_span=SOURCE_LEDGER_SPAN,
        hardware_status=HARDWARE_STATUS,
        claim_boundary=CLAIM_BOUNDARY,
        components={
            component: classify_meta_framework_integrations_p0r03284_component(component)
        ...
        null_controls={
            ...
            "collapse_as_inference_is_not_empirical_validation_evidence": 1.0,
            "psis_field_coupling_integration_is_not_empirical_validation_evidence": 1.0,
        },
        problem_metadata={
            "source_ledger_span": SOURCE_LEDGER_SPAN,
            "source_ledger_ids": tuple(f"P0R{number:05d}" for number in range(3284, 3295)),
            "claim_boundary": CLAIM_BOUNDARY,
            "protocol_state": "source_meta_framework_integrations_p0r03284_only_no_experiment",
        },
    )
