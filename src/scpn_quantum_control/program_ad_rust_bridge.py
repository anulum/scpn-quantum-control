...
elementwise-array, structural-array, static-reduction, and fixed ``multi_dot``
linalg-array replay without importing the larger differentiable-programming
facade.
"""
...
_FORWARD_CLAIM_BOUNDARY = "bounded_rust_program_ad_ir_scalar_and_static_linalg_primitives_executed_branch_view_assignment_and_expression_alias_metadata_only_no_llvm_jit"
_VALUE_AND_GRAD_CLAIM_BOUNDARY = "bounded_rust_program_ad_ir_elementwise_structural_array_static_source_map_static_reductions_and_static_linalg_primitives_value_and_gradient_executed_branch_view_assignment_and_expression_alias_metadata_only_no_llvm_jit"
...
def mirror_program_ad_registry_metadata_with_rust() -> RustProgramADRegistryMetadataMirrorResult:
    ...
    the currently bounded Rust scalar/static-linalg, array, and static
    ``multi_dot`` replay. It does not promote registry-dispatched execution,
