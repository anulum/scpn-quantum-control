...
execution plus observable kernels live in :mod:`.qnode_circuit_execution`. This module
retains derivative propagation, gradients, metrics, and measurements while those
