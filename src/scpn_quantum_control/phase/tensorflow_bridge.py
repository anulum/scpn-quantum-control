...
serialization live in :mod:`.tensorflow_bridge_contracts`. Bounded gradient
implementations live in :mod:`.tensorflow_gradients`. This module retains the
optional loader, signature-stable gradient wrappers, compatibility, lowering,
and maturity orchestration while those executable responsibilities undergo
