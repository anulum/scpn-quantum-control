...
class ParameterShiftQNNOptimizerBenchmarkCaseResult:
    ...
    def passed(self) -> bool:
        ...
        return bool(
            self.parameter_shift_not_worse_than_finite_difference and not self.derivative_free_wins
        )
    ...
    *,
    ...
    for case in _selected_cases(case_names):
        ...
        parameter_shift_evaluations = (
            max(1, len(parameter_shift_training.loss_history)) * 4 * gradient_width
        )
        results.append(
