...
serialization live in :mod:`.qiskit_bridge_contracts`. This module retains
shifted-circuit execution, Runtime capture builders, and maturity orchestration
while those responsibilities undergo bounded decomposition.
"""
