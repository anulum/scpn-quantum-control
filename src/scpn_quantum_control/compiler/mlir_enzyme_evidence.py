...
"""Frozen evidence records for the Enzyme/MLIR compiler-AD maturity surface.

These value records capture the bounded evidence emitted by the Enzyme/MLIR
compiler-AD lane: toolchain detection status, native execution and LLVM
correctness evidence, benchmark attachments, per-case and aggregate compiler-AD
breadth artifacts, and the maturity-audit result. They are self-contained data
contracts with validation only; the emitters and audit logic that build them live
in :mod:`scpn_quantum_control.compiler.mlir`.
"""
