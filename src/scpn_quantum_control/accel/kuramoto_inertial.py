...
triadic or networked forces re-exported from :mod:`scpn_quantum_control.accel`) and the
...
#: bound counterpart of e.g. :func:`~scpn_quantum_control.accel.kuramoto_mean_field.mean_field_jacobian`.
...
#: symmetric-coupling :func:`~scpn_quantum_control.accel.kuramoto_energy.kuramoto_interaction_energy`
