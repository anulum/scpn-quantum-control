...
in :mod:`scpn_quantum_control.accel.kuramoto_noisy_mean_field`; this module is the matching
...
:mod:`scpn_quantum_control.accel`) and reads the coherence with the accelerated
:func:`~scpn_quantum_control.accel.order_parameter_observables.order_parameter`, so the module
