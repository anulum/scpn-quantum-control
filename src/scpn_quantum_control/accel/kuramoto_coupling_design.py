...
:func:`~scpn_quantum_control.accel.kuramoto_control.terminal_objective_value_and_grad`) and takes
...
def optimise_coupling(
    ...
    *,
    ...
    ----------
    objective : TerminalObjective
        A terminal objective (e.g. :func:`~scpn_quantum_control.accel.kuramoto_control.coherence_objective`).
