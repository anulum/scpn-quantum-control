...
:func:`~scpn_quantum_control.accel.kuramoto_delayed.integrate_delayed_kuramoto` (a delay-aware
...
def delayed_phase_sensitivity(
    ...
    *,
    ...
    initial_history : numpy.ndarray
        ...
        ``θ(0)``), matching :func:`~scpn_quantum_control.accel.kuramoto_delayed.integrate_delayed_kuramoto`.
    omega : numpy.ndarray
