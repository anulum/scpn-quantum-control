...
def pairwise_term(
    ...
    Wraps :func:`~scpn_quantum_control.accel.networked_kuramoto.networked_kuramoto_force` and its
...
def hyperedge_term(
    ...
    *,
    ...
    Wraps :func:`~scpn_quantum_control.accel.kuramoto_hyperedge.hyperedge_force` and its Jacobian,
...
def simplex_mean_field_term(
    ...
    Wraps :func:`~scpn_quantum_control.accel.kuramoto_simplex_mean_field.simplex_mean_field_force`
