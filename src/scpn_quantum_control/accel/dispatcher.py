...
_REGISTRY: dict[str, MultiLangDispatcher] = {
    ...
    "mean_phase": _mean_phase_dispatcher,
    "mean_phase_gradient": _mean_phase_gradient_dispatcher,
    "mean_phase_hessian": _mean_phase_hessian_dispatcher,
    "daido_order_parameter": _daido_order_parameter_dispatcher,
    "daido_order_parameter_gradient": _daido_order_parameter_gradient_dispatcher,
}
