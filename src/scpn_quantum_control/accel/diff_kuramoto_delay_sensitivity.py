...
:mod:`~scpn_quantum_control.accel.diff_kuramoto_delayed` gives the gradient of a terminal objective
...
reproduces :func:`~scpn_quantum_control.accel.kuramoto_delayed.integrate_delayed_kuramoto` on a
