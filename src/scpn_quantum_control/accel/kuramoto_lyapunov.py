...
:func:`~scpn_quantum_control.accel.networked_kuramoto.networked_kuramoto_force` and
:func:`~scpn_quantum_control.accel.networked_kuramoto.networked_kuramoto_jacobian`, so the module
