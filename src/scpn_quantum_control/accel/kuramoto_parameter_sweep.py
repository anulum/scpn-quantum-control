...
* :class:`~scpn_quantum_control.accel.kuramoto_system.KuramotoSystem` supplies the
  rule, the initial state and the fixed-step integrator via
  :meth:`~scpn_quantum_control.accel.kuramoto_system.KuramotoSystem.trajectory`;
* :class:`~scpn_quantum_control.accel.kuramoto_system.KuramotoParameters` supplies
  the immutable ``with_parameter`` machinery that re-points the system at each grid
  cell without rebuilding the rule;
* the shipped observables (:func:`~scpn_quantum_control.accel.order_parameter_observables.order_parameter`,
  :func:`~scpn_quantum_control.accel.kuramoto_chimera.metastability_index`,
  :func:`~scpn_quantum_control.accel.kuramoto_frequency_order.frequency_synchronisation_index`)
...
#: :meth:`~scpn_quantum_control.accel.kuramoto_system.KuramotoParameters.with_parameter`
...
def sweep_parameter_grid(
    ...
    *,
    ...
    dt : float, optional
        ...
        :attr:`~scpn_quantum_control.accel.kuramoto_system.KuramotoSystem.dt`.
