...
mean-field self-consistency in :mod:`~scpn_quantum_control.accel.kuramoto_critical_coupling`).
...
def ott_antonsen_steady_state(coupling: float, half_width: float) -> float:
    ...
    (:func:`~scpn_quantum_control.accel.kuramoto_critical_coupling.lorentzian_order_parameter`).
