...
# SCPN Quantum Control — scpn quantum engine module
...
def daido_mode_phase(theta: _F64Array, m: int) -> float: ...
def daido_mode_phase_gradient(theta: _F64Array, m: int) -> _F64Array: ...
def daido_mode_phase_hessian(theta: _F64Array, m: int) -> _F64Array: ...
def mean_field_force(theta: _F64Array, coupling: float) -> _F64Array: ...
def mean_field_jacobian(theta: _F64Array, coupling: float) -> _F64Array: ...
def daido_mean_field_force(theta: _F64Array, coupling: float, m: int) -> _F64Array: ...
def daido_mean_field_jacobian(theta: _F64Array, coupling: float, m: int) -> _F64Array: ...
def networked_kuramoto_force(theta: _F64Array, coupling: _F64Array) -> _F64Array: ...
def networked_kuramoto_jacobian(theta: _F64Array, coupling: _F64Array) -> _F64Array: ...
def kuramoto_interaction_energy(theta: _F64Array, coupling: _F64Array) -> float: ...
def kuramoto_interaction_energy_gradient(theta: _F64Array, coupling: _F64Array) -> _F64Array: ...
def kuramoto_interaction_energy_hessian(theta: _F64Array, coupling: _F64Array) -> _F64Array: ...
def sakaguchi_force(theta: _F64Array, coupling: _F64Array, frustration: float) -> _F64Array: ...
def sakaguchi_jacobian(theta: _F64Array, coupling: _F64Array, frustration: float) -> _F64Array: ...
def sakaguchi_mean_field_force(
    theta: _F64Array, coupling: float, frustration: float
) -> _F64Array: ...
def sakaguchi_mean_field_jacobian(
    theta: _F64Array, coupling: float, frustration: float
) -> _F64Array: ...
def triadic_mean_field_force(theta: _F64Array, coupling: float) -> _F64Array: ...
def triadic_mean_field_jacobian(theta: _F64Array, coupling: float) -> _F64Array: ...
...
def local_mean_phase_jacobian(theta: _F64Array, adjacency: _F64Array) -> _F64Array: ...
