...
# scpn-quantum-control — Kuramoto handbook worked workflow
"""Worked Kuramoto workflow using the production facade and no credentials.

The workflow is intentionally small and deterministic. It exercises the public
``scpn_quantum_control.kuramoto`` facade across the Phase 5 handbook path:
accelerated RK4 integration, frequency-locking diagnostics, linear stability,
phase-coherence clustering, mean-field critical-coupling theory, and projected
synchronising-coupling design.
"""
