...
- differentiable-programming kernels and conformance rows for supported
  scalar, vector, matrix, shape, assembly, cumulative, and reduction primitives;
