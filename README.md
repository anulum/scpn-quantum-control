...
- differentiable-programming kernels and conformance rows for supported
  scalar, vector, matrix, broadcast, shape, assembly, cumulative, and reduction
  primitives;
