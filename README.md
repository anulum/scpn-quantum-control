...
`scpn-quantum-control` is a bridge from coupled-oscillator models to
quantum workflows with an explicit evidence boundary. If your team needs
reproducible research or product-grade experimentation, the repository provides:
...
| Public Python classes | 1638 |
| Paper 0 validation modules | 466 |
| Domain package families | 28 |
| API documentation pages | 0 |
| Rust PyO3 function bindings | 118 |
| Rust source modules | 29 |
| Notebook files | 98 |
| Example files | 23 |
| Optional extras | 42 |
| Python test files | 1925 |
