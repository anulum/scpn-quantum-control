...
if TYPE_CHECKING:
    from tools import adaptive_branching_quality_gates as _adaptive_branching_quality_gates
    ...
    from tools import (
        differentiable_implicit_sensitivity_quality_gates as _differentiable_implicit_sensitivity_quality_gates,
    )
    from tools import (
        differentiable_jax_adapter_quality_gates as _differentiable_jax_adapter_quality_gates,
    )
    from tools import (
    ...
    from tools import entropy_randomness_quality_gates as _entropy_randomness_quality_gates
    from tools import error_aware_chain_quality_gates as _error_aware_chain_quality_gates
    from tools import (
        error_mitigation_product_quality_gates as _error_mitigation_product_quality_gates,
    )
    from tools import experiment_dynamics_quality_gates as _experiment_dynamics_quality_gates
    from tools import experiment_helpers_quality_gates as _experiment_helpers_quality_gates
    ...
    from tools import gpu_batch_vqe_quality_gates as _gpu_batch_vqe_quality_gates
    ...
    _error_aware_chain_quality_gates = import_module("tools.error_aware_chain_quality_gates")
    ...
    _qrc_baseline_quality_gates = import_module("tools.qrc_baseline_quality_gates")
    ...
    _experiment_helpers_quality_gates = import_module("tools.experiment_helpers_quality_gates")
    ...
    _differentiable_implicit_sensitivity_quality_gates = import_module(
        "tools.differentiable_implicit_sensitivity_quality_gates"
    )
    _differentiable_jax_adapter_quality_gates = import_module(
        "tools.differentiable_jax_adapter_quality_gates"
    )
    ...
    _layout_relaxation_experiment_quality_gates = import_module(
        "tools.layout_relaxation_experiment_quality_gates"
    )
...
MLIR_LEAF_QUALITY_RATCHET = [
    ...
    "src/scpn_quantum_control/compiler/mlir_matrix_2x2_native_compilation.py",
    ...
    "src/scpn_quantum_control/compiler/mlir_vector_native_compilation.py",
    ...
    "tests/test_mlir_vector_native_compilation_validation.py",
    ...
    "tests/test_mlir_matrix_2x2_native_compilation_validation.py",
...
MLIR_LEAF_COVERAGE_INCLUDE = (
    ...
    "*/mlir_matrix_2x2_native_compilation.py,*/mlir_matrix_native_compilation.py,"
    "*/mlir_phase_qnode_runtime.py,"
    "*/mlir_transform_plan_assembly.py,"
    "*/mlir_vector_native_compilation.py,"
...
STATIC_GATES: list[tuple[str, list[str]]] = [
    ...
    *_differentiable_implicit_sensitivity_quality_gates.build_static_quality_gates(_PY),
    ...
    *_whole_program_trace_value_quality_gates.build_static_quality_gates(_PY),
    ...
    ("toolchain-declaration-alignment", [_PY, "tools/check_toolchain_pin_alignment.py"]),
...
DIFFERENTIABLE_IMPLICIT_SENSITIVITY_COVERAGE_GATES = (
    _differentiable_implicit_sensitivity_quality_gates.build_coverage_gates(_PY)
)
...
def main() -> int:
    ...
    if not skip_tests:
        ...
        if no_coverage:
            ...
            gates.extend(DIFFERENTIABLE_IMPLICIT_SENSITIVITY_COVERAGE_GATES)
