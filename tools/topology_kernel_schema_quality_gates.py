...
TOPOLOGY_KERNEL_SCHEMA_COVERAGE_COHORT = ["tests/test_topology_kernel_product_schema.py"]
"""Tests that own exact topology-kernel schema coverage."""
    ...
    return [
        ...
        (
            ...
            [
                ...
                "--precision=2",
                "--fail-under=100",
                "--include=*/topology_kernel_product/schema.py",
            ],
        ),
    ]
