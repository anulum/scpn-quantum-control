...
# scpn-quantum-control -- Paper 0 2. The Synaptic Junction and Downward Causation (L2): fixture runner
"""Run the Paper 0 2. The Synaptic Junction and Downward Causation (L2): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_synaptic_junction_and_downward_causation_l2_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_synaptic_junction_and_downward_causation_l2_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2. The Synaptic Junction and Downward Causation (L2):" + " Fixture",
        "",
