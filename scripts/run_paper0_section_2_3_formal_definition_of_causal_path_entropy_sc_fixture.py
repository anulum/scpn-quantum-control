...
# scpn-quantum-control -- Paper 0 2.3 Formal Definition of Causal Path Entropy (SC) fixture runner
"""Run the Paper 0 2.3 Formal Definition of Causal Path Entropy (SC) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_3_formal_definition_of_causal_path_entropy_sc_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_3_formal_definition_of_causal_path_entropy_sc_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2.3 Formal Definition of Causal Path Entropy (SC)" + " Fixture",
        "",
