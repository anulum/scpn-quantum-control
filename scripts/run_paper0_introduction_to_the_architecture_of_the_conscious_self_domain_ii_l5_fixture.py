...
# scpn-quantum-control -- Paper 0 Introduction to The Architecture of the Conscious Self (Domain II: L5) fixture runner
"""Run the Paper 0 Introduction to The Architecture of the Conscious Self (Domain II: L5) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_introduction_to_the_architecture_of_the_conscious_self_domain_ii_l5_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_introduction_to_the_architecture_of_the_conscious_self_domain_ii_l5_fixture_report_2026-05-17.md"
)
