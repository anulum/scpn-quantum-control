...
# scpn-quantum-control -- Paper 0 IV. The Integrated Scenario: Pharmacological Modulation of the Traumatised Brain fixture runner
"""Run the Paper 0 IV. The Integrated Scenario: Pharmacological Modulation of the Traumatised Brain source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_integrated_scenario_pharmacological_modulation_of_the_traumatised_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_integrated_scenario_pharmacological_modulation_of_the_traumatised_fixture_report_2026-05-17.md"
)
