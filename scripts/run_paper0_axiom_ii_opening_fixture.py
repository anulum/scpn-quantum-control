...
# scpn-quantum-control -- Paper 0 Axiom II opening fixture runner
"""Run the Paper 0 Axiom II opening source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_opening_fixture_result_2026-05-13.json"
DEFAULT_REPORT_PATH = DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_opening_fixture_report_2026-05-13.md"
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom II Opening Fixture",
        "",
        ...
        f"- Heading records: {payload['heading_record_count']}",
        f"- Axiom statements: {payload['axiom_statement_count']}",
        f"- Falsifiability boundaries: {payload['falsifiability_boundary_count']}",
