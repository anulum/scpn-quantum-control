...
# scpn-quantum-control -- Paper 0 XI. The Mathematics of Hierarchy and Scale Invariance fixture runner
"""Run the Paper 0 XI. The Mathematics of Hierarchy and Scale Invariance source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_xi_the_mathematics_of_hierarchy_and_scale_invariance_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_xi_the_mathematics_of_hierarchy_and_scale_invariance_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "XI. The Mathematics of Hierarchy and Scale Invariance" + " Fixture",
        "",
