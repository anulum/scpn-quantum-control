...
# scpn-quantum-control -- Paper 0 Integration of CEF into the Path Integral Formalism: fixture runner
"""Run the Paper 0 Integration of CEF into the Path Integral Formalism: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_integration_of_cef_into_the_path_integral_formalism_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_integration_of_cef_into_the_path_integral_formalism_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Integration of CEF into the Path Integral Formalism:" + " Fixture",
        "",
