...
# scpn-quantum-control -- Paper 0 Localised: fixture runner
"""Run the Paper 0 Localised: source-accounting fixture."""
...
from scpn_quantum_control.paper0.localised_validation import validate_localised_fixture

REPO_ROOT = Path(__file__).resolve().parents[1]
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs" / "internal" / "paper0_foundational_extraction"
DEFAULT_OUTPUT_PATH = DEFAULT_OUTPUT_DIR / "paper0_localised_fixture_result_2026-05-17.json"
DEFAULT_REPORT_PATH = DEFAULT_OUTPUT_DIR / "paper0_localised_fixture_report_2026-05-17.md"
