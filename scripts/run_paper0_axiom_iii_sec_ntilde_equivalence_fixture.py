...
# scpn-quantum-control -- Paper 0 Axiom III SEC-Ntilde equivalence fixture runner
"""Run the Paper 0 Axiom III SEC-Ntilde-equivalence source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_iii_sec_ntilde_equivalence_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_iii_sec_ntilde_equivalence_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom III SEC-Ntilde Equivalence Fixture",
        "",
        ...
        f"- Equivalence-claim records: {payload['equivalence_claim_count']}",
        f"- Architecture-target records: {payload['architecture_target_count']}",
        f"- Efficiency-claim records: {payload['efficiency_claim_count']}",
        f"- Blank terminal records: {payload['blank_terminal_record_count']}",
