...
# scpn-quantum-control -- Paper 0 III. The Extracellular Milieu: ECM and PNNs (L3/L4) fixture runner
"""Run the Paper 0 III. The Extracellular Milieu: ECM and PNNs (L3/L4) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_extracellular_milieu_ecm_and_pnns_l3_l4_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_extracellular_milieu_ecm_and_pnns_l3_l4_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "III. The Extracellular Milieu: ECM and PNNs (L3/L4)" + " Fixture",
        "",
