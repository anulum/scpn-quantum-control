...
# scpn-quantum-control -- Paper 0 Proposed Experimental Protocol: Correlating QRNG Statistical Deviations with Collective Coherence Metrics fixture runner
"""Run the Paper 0 Proposed Experimental Protocol: Correlating QRNG Statistical Deviations with Collective Coherence Metrics source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_proposed_experimental_protocol_correlating_qrng_statistical_deviations_w_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_proposed_experimental_protocol_correlating_qrng_statistical_deviations_w_fixture_report_2026-05-17.md"
)
