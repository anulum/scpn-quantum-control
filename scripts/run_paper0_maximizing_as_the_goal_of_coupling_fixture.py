...
# scpn-quantum-control -- Paper 0 Maximizing  as the Goal of Coupling: fixture runner
"""Run the Paper 0 Maximizing  as the Goal of Coupling: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_maximizing_as_the_goal_of_coupling_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_maximizing_as_the_goal_of_coupling_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Maximizing  as the Goal of Coupling:" + " Fixture",
        "",
