...
from scpn_quantum_control.paper0.paper0_slice_validation import validate_paper0_slice_fixture

REPO_ROOT = Path(__file__).resolve().parents[1]
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs" / "internal" / "paper0_foundational_extraction"
DEFAULT_OUTPUT_PATH = DEFAULT_OUTPUT_DIR / "paper0_paper0_slice_fixture_result_2026-05-17.json"
DEFAULT_REPORT_PATH = DEFAULT_OUTPUT_DIR / "paper0_paper0_slice_fixture_report_2026-05-17.md"
