...
# scpn-quantum-control -- Paper 0 III. The SCPN Measurement Postulate (IIT-OR and QZE) fixture runner
"""Run the Paper 0 III. The SCPN Measurement Postulate (IIT-OR and QZE) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_scpn_measurement_postulate_iit_or_and_qze_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_scpn_measurement_postulate_iit_or_and_qze_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "III. The SCPN Measurement Postulate (IIT-OR and QZE)" + " Fixture",
        "",
