...
# scpn-quantum-control -- Paper 0 VII. Pathology: The Disordered Brain fixture runner
"""Run the Paper 0 VII. Pathology: The Disordered Brain source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_vii_pathology_the_disordered_brain_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_vii_pathology_the_disordered_brain_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "VII. Pathology: The Disordered Brain" + " Fixture",
        "",
