...
# scpn-quantum-control -- Paper 0 Resolving the Amplitude Friction: The Stuart-Landau Upgrade for Precision Weighting fixture runner
"""Run the Paper 0 Resolving the Amplitude Friction: The Stuart-Landau Upgrade for Precision Weighting source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_amplitude_friction_the_stuart_landau_upgrade_for_precision_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_amplitude_friction_the_stuart_landau_upgrade_for_precision_fixture_report_2026-05-17.md"
)
