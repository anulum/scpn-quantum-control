...
# scpn-quantum-control -- Paper 0 Integration with Integrated Information Theory (IIT) 4.0 fixture runner
"""Run the Paper 0 Integration with Integrated Information Theory (IIT) 4.0 source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_integration_with_integrated_information_theory_iit_4_0_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_integration_with_integrated_information_theory_iit_4_0_fixture_report_2026-05-17.md"
)
