...
# scpn-quantum-control -- Paper 0 tripartite ontology fixture runner
"""Run the Paper 0 tripartite-ontology source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_tripartite_ontology_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_tripartite_ontology_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Tripartite Ontology Fixture",
        "",
        ...
        f"- Formal ontology records: {payload['formal_ontology_record_count']}",
        f"- Explanatory analogy records: {payload['explanatory_analogy_record_count']}",
        f"- Information forms: {payload['information_form_count']}",
        f"- Transduction directions: {payload['transduction_direction_count']}",
