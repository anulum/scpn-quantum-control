...
# scpn-quantum-control -- Paper 0  Linguistics & Symbolism (VIBRANA, Layer 7) fixture runner
"""Run the Paper 0  Linguistics & Symbolism (VIBRANA, Layer 7) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_linguistics_symbolism_vibrana_layer_7_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_linguistics_symbolism_vibrana_layer_7_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + " Linguistics & Symbolism (VIBRANA, Layer 7)" + " Fixture",
        "",
