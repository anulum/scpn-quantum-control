...
# scpn-quantum-control -- Paper 0 Domain III Overview: Memory and Projection Control fixture runner
"""Run the Paper 0 Domain III Overview: Memory and Projection Control source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_domain_iii_overview_memory_and_projection_control_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_domain_iii_overview_memory_and_projection_control_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Domain III Overview: Memory and Projection Control" + " Fixture",
        "",
