...
# scpn-quantum-control -- Paper 0 Non-Abelian qualia field fixture runner
"""Run the Paper 0 Non-Abelian qualia-field source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_non_abelian_qualia_field_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_non_abelian_qualia_field_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Non-Abelian Qualia Field Fixture",
        "",
        ...
        f"- Context records: {payload['context_record_count']}",
        f"- Claim records: {payload['claim_record_count']}",
        f"- Validation-target records: {payload['validation_target_record_count']}",
        f"- Structural records: {payload['structural_record_count']}",
        f"- Anomaly-condition records: {payload['anomaly_condition_record_count']}",
        f"- Confinement records: {payload['confinement_record_count']}",
        f"- Topological-entanglement records: {payload['topological_entanglement_record_count']}",
