...
# scpn-quantum-control -- Paper 0 I. The Ontological Origin of Ethics (Gauge Theory Derivation) fixture runner
"""Run the Paper 0 I. The Ontological Origin of Ethics (Gauge Theory Derivation) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_i_the_ontological_origin_of_ethics_gauge_theory_derivation_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_i_the_ontological_origin_of_ethics_gauge_theory_derivation_fixture_report_2026-05-17.md"
)
