...
# scpn-quantum-control -- Paper 0 L15 Reformulation: The SEC Objective Functional (Decision-Theoretic Form) (revision 11.00) fixture runner
"""Run the Paper 0 L15 Reformulation: The SEC Objective Functional (Decision-Theoretic Form) (revision 11.00) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_l15_reformulation_the_sec_objective_functional_decision_theoretic_form_r_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_l15_reformulation_the_sec_objective_functional_decision_theoretic_form_r_fixture_report_2026-05-17.md"
)
