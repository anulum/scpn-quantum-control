...
# scpn-quantum-control -- Paper 0 2.1 The State Space and Path Space fixture runner
"""Run the Paper 0 2.1 The State Space and Path Space source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_1_the_state_space_and_path_space_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_1_the_state_space_and_path_space_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2.1 The State Space and Path Space" + " Fixture",
        "",
