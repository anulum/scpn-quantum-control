...
# scpn-quantum-control -- Paper 0 III. The Coherence Backbone: Multi-Scale Quantum Error Correction (MS-QEC) fixture runner
"""Run the Paper 0 III. The Coherence Backbone: Multi-Scale Quantum Error Correction (MS-QEC) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_coherence_backbone_multi_scale_quantum_error_correction_ms_qec_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_coherence_backbone_multi_scale_quantum_error_correction_ms_qec_fixture_report_2026-05-17.md"
)
