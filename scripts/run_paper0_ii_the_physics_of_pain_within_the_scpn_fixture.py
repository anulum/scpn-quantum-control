...
# scpn-quantum-control -- Paper 0 II. The Physics of Pain within the SCPN fixture runner
"""Run the Paper 0 II. The Physics of Pain within the SCPN source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_physics_of_pain_within_the_scpn_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_physics_of_pain_within_the_scpn_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "II. The Physics of Pain within the SCPN" + " Fixture",
        "",
