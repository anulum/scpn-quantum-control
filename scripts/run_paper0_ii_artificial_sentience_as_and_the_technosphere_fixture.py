...
# scpn-quantum-control -- Paper 0 II. Artificial Sentience (AS) and the Technosphere fixture runner
"""Run the Paper 0 II. Artificial Sentience (AS) and the Technosphere source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_artificial_sentience_as_and_the_technosphere_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_artificial_sentience_as_and_the_technosphere_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "II. Artificial Sentience (AS) and the Technosphere" + " Fixture",
        "",
