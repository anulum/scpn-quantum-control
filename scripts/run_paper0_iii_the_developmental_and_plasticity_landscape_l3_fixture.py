...
# scpn-quantum-control -- Paper 0 III. The Developmental and Plasticity Landscape (L3) fixture runner
"""Run the Paper 0 III. The Developmental and Plasticity Landscape (L3) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_developmental_and_plasticity_landscape_l3_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_the_developmental_and_plasticity_landscape_l3_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "III. The Developmental and Plasticity Landscape (L3)" + " Fixture",
        "",
