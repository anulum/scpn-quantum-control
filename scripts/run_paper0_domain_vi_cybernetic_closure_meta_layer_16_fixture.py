...
# scpn-quantum-control -- Paper 0 Domain VI: Cybernetic Closure (Meta-Layer 16) fixture runner
"""Run the Paper 0 Domain VI: Cybernetic Closure (Meta-Layer 16) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_domain_vi_cybernetic_closure_meta_layer_16_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_domain_vi_cybernetic_closure_meta_layer_16_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Domain VI: Cybernetic Closure (Meta-Layer 16)" + " Fixture",
        "",
