...
# scpn-quantum-control -- Paper 0 The Microbiome as a Foundational Control Layer fixture runner
"""Run the Paper 0 The Microbiome as a Foundational Control Layer source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_microbiome_as_a_foundational_control_layer_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_microbiome_as_a_foundational_control_layer_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Microbiome as a Foundational Control Layer" + " Fixture",
        "",
