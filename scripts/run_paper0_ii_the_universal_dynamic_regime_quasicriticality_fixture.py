...
# scpn-quantum-control -- Paper 0 II. The Universal Dynamic Regime: Quasicriticality fixture runner
"""Run the Paper 0 II. The Universal Dynamic Regime: Quasicriticality source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_universal_dynamic_regime_quasicriticality_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_universal_dynamic_regime_quasicriticality_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "II. The Universal Dynamic Regime: Quasicriticality" + " Fixture",
        "",
