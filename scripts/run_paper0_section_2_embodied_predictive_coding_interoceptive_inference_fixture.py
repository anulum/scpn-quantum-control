...
# scpn-quantum-control -- Paper 0 2. Embodied Predictive Coding (Interoceptive Inference) fixture runner
"""Run the Paper 0 2. Embodied Predictive Coding (Interoceptive Inference) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_embodied_predictive_coding_interoceptive_inference_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_embodied_predictive_coding_interoceptive_inference_fixture_report_2026-05-17.md"
)
