...
# scpn-quantum-control -- Paper 0 V. The Integrated Body Matrix (Fascia and Tensegrity) fixture runner
"""Run the Paper 0 V. The Integrated Body Matrix (Fascia and Tensegrity) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_v_the_integrated_body_matrix_fascia_and_tensegrity_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_v_the_integrated_body_matrix_fascia_and_tensegrity_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "V. The Integrated Body Matrix (Fascia and Tensegrity)" + " Fixture",
        "",
