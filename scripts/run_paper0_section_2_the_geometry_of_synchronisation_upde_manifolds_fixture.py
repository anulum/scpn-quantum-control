...
# scpn-quantum-control -- Paper 0 2. The Geometry of Synchronisation (UPDE Manifolds): fixture runner
"""Run the Paper 0 2. The Geometry of Synchronisation (UPDE Manifolds): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_geometry_of_synchronisation_upde_manifolds_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_geometry_of_synchronisation_upde_manifolds_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2. The Geometry of Synchronisation (UPDE Manifolds):" + " Fixture",
        "",
