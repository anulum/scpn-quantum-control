...
# scpn-quantum-control -- Paper 0 Axiom II informational Lagrangian fixture runner
"""Run the Paper 0 Axiom II informational-Lagrangian source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_informational_lagrangian_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_informational_lagrangian_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom II Informational Lagrangian Fixture",
        "",
        ...
        f"- Gauge equations: {payload['gauge_equation_count']}",
        f"- Standard gauge baseline records: {payload['standard_gauge_baseline_count']}",
        f"- SCPN gauge records: {payload['scpn_gauge_count']}",
        f"- Pullback protocol records: {payload['pullback_protocol_count']}",
