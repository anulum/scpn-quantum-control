...
# scpn-quantum-control -- Paper 0 V. The Interface Problem Synthesis (Mind-Body-Field) fixture runner
"""Run the Paper 0 V. The Interface Problem Synthesis (Mind-Body-Field) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_v_the_interface_problem_synthesis_mind_body_field_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_v_the_interface_problem_synthesis_mind_body_field_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "V. The Interface Problem Synthesis (Mind-Body-Field)" + " Fixture",
        "",
