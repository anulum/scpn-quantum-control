...
# scpn-quantum-control -- Paper 0 Layer 5 Active Inference math fixture runner
"""Run the Paper 0 Layer 5 Active Inference math source-bounded fixture."""
...
def write_outputs(
    *,
    ...
    result = validate_l5_active_inference_math_fixture(
        L5ActiveInferenceMathConfig(spec_bundle_path=spec_bundle_path)
    )
...
def main() -> int:
    """Run the default Layer 5 Active Inference math fixture."""
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument(
        "--output",
        type=Path,
        default=DEFAULT_EXTRACTION_DIR
        / "paper0_l5_active_inference_math_fixture_result_2026-05-13.json",
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=DEFAULT_EXTRACTION_DIR
        / "paper0_l5_active_inference_math_fixture_report_2026-05-13.md",
    )
