...
# scpn-quantum-control -- Paper 0 Slow Control Layer: Neuroendocrine Integration fixture runner
"""Run the Paper 0 Slow Control Layer: Neuroendocrine Integration source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_slow_control_layer_neuroendocrine_integration_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_slow_control_layer_neuroendocrine_integration_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Slow Control Layer: Neuroendocrine Integration" + " Fixture",
        "",
