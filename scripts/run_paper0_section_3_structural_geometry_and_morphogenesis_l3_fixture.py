...
# scpn-quantum-control -- Paper 0 3. Structural Geometry and Morphogenesis (L3): fixture runner
"""Run the Paper 0 3. Structural Geometry and Morphogenesis (L3): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_structural_geometry_and_morphogenesis_l3_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_structural_geometry_and_morphogenesis_l3_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "3. Structural Geometry and Morphogenesis (L3):" + " Fixture",
        "",
