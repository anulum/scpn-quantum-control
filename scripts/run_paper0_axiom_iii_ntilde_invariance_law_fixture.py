...
# scpn-quantum-control -- Paper 0 Axiom III Ntilde invariance-law fixture runner
"""Run the Paper 0 Axiom III Ntilde-invariance-law source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_iii_ntilde_invariance_law_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_iii_ntilde_invariance_law_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom III Ntilde Invariance Law Fixture",
        "",
        ...
        f"- Invariant-definition records: {payload['invariant_definition_count']}",
        f"- Variable-definition records: {payload['variable_definition_count']}",
        f"- Threshold-equation records: {payload['threshold_equation_count']}",
        f"- Reversible-limit records: {payload['reversible_limit_count']}",
