...
# scpn-quantum-control -- Paper 0 Overarching Dynamic Principles and the Mathematical Spine fixture runner
"""Run the Paper 0 Overarching Dynamic Principles and the Mathematical Spine source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_overarching_dynamic_principles_and_the_mathematical_spine_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_overarching_dynamic_principles_and_the_mathematical_spine_fixture_report_2026-05-17.md"
)
