...
# scpn-quantum-control -- Paper 0 The Unifying Computational Principle: Hierarchical Predictive Coding (HPC) fixture runner
"""Run the Paper 0 The Unifying Computational Principle: Hierarchical Predictive Coding (HPC) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_unifying_computational_principle_hierarchical_predictive_coding_hpc_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_unifying_computational_principle_hierarchical_predictive_coding_hpc_fixture_report_2026-05-17.md"
)
