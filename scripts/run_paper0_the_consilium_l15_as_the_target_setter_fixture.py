...
# scpn-quantum-control -- Paper 0 The Consilium (L15) as the Target Setter: fixture runner
"""Run the Paper 0 The Consilium (L15) as the Target Setter: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_consilium_l15_as_the_target_setter_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_consilium_l15_as_the_target_setter_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Consilium (L15) as the Target Setter:" + " Fixture",
        "",
