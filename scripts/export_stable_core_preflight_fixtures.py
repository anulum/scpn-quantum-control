...
# SCPN Quantum Control — export stable core preflight fixtures script
# scpn-quantum-control -- stable core preflight fixtures exporter
"""Export deterministic stable-core preflight fixtures."""
...
def _load_comparator_module() -> ModuleType:
    ...
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load stable-core preflight fixture comparator module")
...
DEFAULT_JSON = REPO_ROOT / "data" / "stable_core" / "stable_core_preflight_fixtures.json"
DEFAULT_DOC = REPO_ROOT / "docs" / "stable_core_preflight_fixtures.md"
...
def main() -> int:
    ...
    digests = comparator.write_stable_core_preflight_fixtures(
