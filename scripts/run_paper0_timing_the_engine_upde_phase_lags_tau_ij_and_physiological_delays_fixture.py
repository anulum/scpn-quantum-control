...
# scpn-quantum-control -- Paper 0 Timing the Engine: UPDE Phase-Lags ($\tau_{ij}$) and Physiological Delays fixture runner
"""Run the Paper 0 Timing the Engine: UPDE Phase-Lags ($\tau_{ij}$) and Physiological Delays source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_timing_the_engine_upde_phase_lags_tau_ij_and_physiological_delays_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_timing_the_engine_upde_phase_lags_tau_ij_and_physiological_delays_fixture_report_2026-05-17.md"
)
