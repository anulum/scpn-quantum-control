...
# scpn-quantum-control -- Paper 0 master Lagrangian intro fixture runner
"""Run the Paper 0 master-Lagrangian-intro source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_master_lagrangian_intro_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_master_lagrangian_intro_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Master Lagrangian Intro Fixture",
        "",
        ...
        f"- Introduction records: {payload['introduction_record_count']}",
        f"- Meta-framework records: {payload['meta_framework_record_count']}",
        f"- Gauge-inference records: {payload['gauge_inference_record_count']}",
        f"- Psis-coupling records: {payload['psis_coupling_record_count']}",
