...
# scpn-quantum-control -- Paper 0 Domain V: Meta-Universal Integration (Layers 13-15) fixture runner
"""Run the Paper 0 Domain V: Meta-Universal Integration (Layers 13-15) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_domain_v_meta_universal_integration_layers_13_15_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_domain_v_meta_universal_integration_layers_13_15_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Domain V: Meta-Universal Integration (Layers 13-15)" + " Fixture",
        "",
