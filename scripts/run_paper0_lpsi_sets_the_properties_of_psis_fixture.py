...
# scpn-quantum-control -- Paper 0 LPsi Sets the Properties of Psis: fixture runner
"""Run the Paper 0 LPsi Sets the Properties of Psis: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_lpsi_sets_the_properties_of_psis_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_lpsi_sets_the_properties_of_psis_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 LPsi Sets the Properties of Psis: Fixture",
        "",
