...
# scpn-quantum-control -- Paper 0 Quantum Enzymology of the Immune Response fixture runner
"""Run the Paper 0 Quantum Enzymology of the Immune Response source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_quantum_enzymology_of_the_immune_response_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_quantum_enzymology_of_the_immune_response_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Quantum Enzymology of the Immune Response" + " Fixture",
        "",
