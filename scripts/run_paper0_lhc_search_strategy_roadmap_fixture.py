...
# scpn-quantum-control -- Paper 0 LHC search-strategy roadmap fixture runner
"""Run the Paper 0 LHC search-strategy roadmap source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_lhc_search_strategy_roadmap_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_lhc_search_strategy_roadmap_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 LHC Search Strategy Roadmap Fixture",
        "",
