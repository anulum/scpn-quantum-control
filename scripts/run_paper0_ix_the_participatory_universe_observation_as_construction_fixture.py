...
# scpn-quantum-control -- Paper 0 IX. The Participatory Universe: Observation as Construction fixture runner
"""Run the Paper 0 IX. The Participatory Universe: Observation as Construction source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ix_the_participatory_universe_observation_as_construction_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ix_the_participatory_universe_observation_as_construction_fixture_report_2026-05-17.md"
)
