...
# scpn-quantum-control -- Paper 0 Neuroendocrine Regulation and the Hypothalamic-Pituitary-Adrenal (HPA) Axis fixture runner
"""Run the Paper 0 Neuroendocrine Regulation and the Hypothalamic-Pituitary-Adrenal (HPA) Axis source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_neuroendocrine_regulation_and_the_hypothalamic_pituitary_adrenal_hpa_axi_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_neuroendocrine_regulation_and_the_hypothalamic_pituitary_adrenal_hpa_axi_fixture_report_2026-05-17.md"
)
