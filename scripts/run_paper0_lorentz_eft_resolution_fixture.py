...
# scpn-quantum-control -- Paper 0 Lorentz EFT resolution fixture runner
"""Run the Paper 0 Lorentz/EFT-resolution source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_lorentz_eft_resolution_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_lorentz_eft_resolution_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Lorentz EFT Resolution Fixture",
        "",
        ...
        f"- Lorentz-tension records: {payload['lorentz_tension_record_count']}",
        f"- Fundamental-action records: {payload['fundamental_action_record_count']}",
        f"- Biological-medium records: {payload['biological_medium_record_count']}",
        f"- Consistency records: {payload['consistency_record_count']}",
        f"- Ghost-action records: {payload['ghost_action_record_count']}",
