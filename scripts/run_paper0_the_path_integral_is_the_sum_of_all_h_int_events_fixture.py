...
# scpn-quantum-control -- Paper 0 The Path Integral is the Sum of all H_int events: fixture runner
"""Run the Paper 0 The Path Integral is the Sum of all H_int events: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_path_integral_is_the_sum_of_all_h_int_events_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_path_integral_is_the_sum_of_all_h_int_events_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Path Integral is the Sum of all H_int events:" + " Fixture",
        "",
