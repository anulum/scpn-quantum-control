...
# scpn-quantum-control -- Paper 0 1. The Emergence of the Self (SSB and the Strange Loop): fixture runner
"""Run the Paper 0 1. The Emergence of the Self (SSB and the Strange Loop): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_1_the_emergence_of_the_self_ssb_and_the_strange_loop_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_1_the_emergence_of_the_self_ssb_and_the_strange_loop_fixture_report_2026-05-17.md"
)
