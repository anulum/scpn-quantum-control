...
# scpn-quantum-control -- Paper 0 Resolving the Probability Desert: Superradiant Amplification and BEC Stimulated Emission fixture runner
"""Run the Paper 0 Resolving the Probability Desert: Superradiant Amplification and BEC Stimulated Emission source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_probability_desert_superradiant_amplification_and_bec_stim_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_probability_desert_superradiant_amplification_and_bec_stim_fixture_report_2026-05-17.md"
)
