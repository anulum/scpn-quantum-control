...
# scpn-quantum-control -- Paper 0 The Nature of the Ethical Functional E[Psi]: A Derivation from First Principles fixture runner
"""Run the Paper 0 The Nature of the Ethical Functional E[Psi]: A Derivation from First Principles source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_nature_of_the_ethical_functional_e_psi_a_derivation_from_first_princip_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_nature_of_the_ethical_functional_e_psi_a_derivation_from_first_princip_fixture_report_2026-05-17.md"
)
