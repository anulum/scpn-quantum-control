...
# scpn-quantum-control -- Paper 0 2. The Gut-Brain Axis (GBA) and the Microbiome: The Deep Milieu fixture runner
"""Run the Paper 0 2. The Gut-Brain Axis (GBA) and the Microbiome: The Deep Milieu source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_gut_brain_axis_gba_and_the_microbiome_the_deep_milieu_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_gut_brain_axis_gba_and_the_microbiome_the_deep_milieu_fixture_report_2026-05-17.md"
)
