...
# scpn-quantum-control -- Paper 0 3.2 Coherence (C) and the Accessibility of Trajectories fixture runner
"""Run the Paper 0 3.2 Coherence (C) and the Accessibility of Trajectories source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_2_coherence_c_and_the_accessibility_of_trajectories_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_2_coherence_c_and_the_accessibility_of_trajectories_fixture_report_2026-05-17.md"
)
