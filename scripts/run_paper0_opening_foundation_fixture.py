...
# scpn-quantum-control -- Paper 0 opening foundation fixture runner
"""Run the Paper 0 opening foundation and global-boundary axiom fixture."""
...
def write_outputs(
    *,
    ...
    result = validate_opening_foundation_fixture(
        OpeningFoundationConfig(spec_bundle_path=spec_bundle_path)
    )
...
def main() -> int:
    """Run the default opening foundation fixture."""
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument(
        "--output",
        type=Path,
        default=DEFAULT_EXTRACTION_DIR
        / "paper0_opening_foundation_fixture_result_2026-05-13.json",
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=DEFAULT_EXTRACTION_DIR / "paper0_opening_foundation_fixture_report_2026-05-13.md",
    )
