...
# scpn-quantum-control -- Paper 0 predicted particles fixture runner
"""Run the Paper 0 infoton and Psi-Higgs prediction source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_predicted_particles_infoton_psi_higgs_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_predicted_particles_infoton_psi_higgs_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Predicted Particles Infoton Psi-Higgs Fixture",
        "",
