...
# scpn-quantum-control -- Paper 0 meta-framework Psi coupling fixture runner
"""Run the Paper 0 meta-framework/Psi-coupling source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_meta_framework_psi_coupling_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_meta_framework_psi_coupling_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Meta-Framework Psi Coupling Fixture",
        "",
        ...
        f"- Predictive-coding records: {payload['predictive_coding_record_count']}",
        f"- Psi-coupling records: {payload['psi_coupling_record_count']}",
        f"- Formal-restatement records: {payload['formal_restatement_record_count']}",
        f"- Image / figure records: {payload['image_or_figure_record_count']}",
