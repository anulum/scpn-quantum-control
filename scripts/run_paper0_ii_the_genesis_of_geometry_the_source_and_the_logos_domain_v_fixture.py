...
# scpn-quantum-control -- Paper 0 II. The Genesis of Geometry: The Source and the Logos (Domain V) fixture runner
"""Run the Paper 0 II. The Genesis of Geometry: The Source and the Logos (Domain V) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_genesis_of_geometry_the_source_and_the_logos_domain_v_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_genesis_of_geometry_the_source_and_the_logos_domain_v_fixture_report_2026-05-17.md"
)
