...
# scpn-quantum-control -- Paper 0 The Definition of the Self: The Triadic Solution fixture runner
"""Run the Paper 0 The Definition of the Self: The Triadic Solution source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_definition_of_the_self_the_triadic_solution_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_definition_of_the_self_the_triadic_solution_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Definition of the Self: The Triadic Solution" + " Fixture",
        "",
