...
# scpn-quantum-control -- Paper 0 experimental signatures fixture runner
"""Run the Paper 0 experimental-signatures search-strategy source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_experimental_signatures_search_strategies_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_experimental_signatures_search_strategies_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Experimental Signatures Search Strategies Fixture",
        "",
