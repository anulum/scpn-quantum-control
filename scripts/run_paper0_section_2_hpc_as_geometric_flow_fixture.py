...
# scpn-quantum-control -- Paper 0 2. HPC as Geometric Flow: fixture runner
"""Run the Paper 0 2. HPC as Geometric Flow: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_section_2_hpc_as_geometric_flow_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_section_2_hpc_as_geometric_flow_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2. HPC as Geometric Flow:" + " Fixture",
        "",
