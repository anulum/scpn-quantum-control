...
# scpn-quantum-control -- Paper 0 1. The Cytoskeleton: The L1 Quantum Scaffold fixture runner
"""Run the Paper 0 1. The Cytoskeleton: The L1 Quantum Scaffold source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_1_the_cytoskeleton_the_l1_quantum_scaffold_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_1_the_cytoskeleton_the_l1_quantum_scaffold_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "1. The Cytoskeleton: The L1 Quantum Scaffold" + " Fixture",
        "",
