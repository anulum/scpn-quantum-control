...
# scpn-quantum-control -- Paper 0 VIII. The Synthesis of Subjectivity (The Triadic Solution) fixture runner
"""Run the Paper 0 VIII. The Synthesis of Subjectivity (The Triadic Solution) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_viii_the_synthesis_of_subjectivity_the_triadic_solution_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_viii_the_synthesis_of_subjectivity_the_triadic_solution_fixture_report_2026-05-17.md"
)
