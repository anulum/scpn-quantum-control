...
# scpn-quantum-control -- Paper 0 Introduction to The Dynamics of the Coherent Brain (Domain I: L4) fixture runner
"""Run the Paper 0 Introduction to The Dynamics of the Coherent Brain (Domain I: L4) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_introduction_to_the_dynamics_of_the_coherent_brain_domain_i_l4_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_introduction_to_the_dynamics_of_the_coherent_brain_domain_i_l4_fixture_report_2026-05-17.md"
)
