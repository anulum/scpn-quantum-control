...
# scpn-quantum-control -- Paper 0 Resolving the Erasure Paradox: Lossy Compression and the Heat Sink Boundary fixture runner
"""Run the Paper 0 Resolving the Erasure Paradox: Lossy Compression and the Heat Sink Boundary source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_erasure_paradox_lossy_compression_and_the_heat_sink_bounda_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_erasure_paradox_lossy_compression_and_the_heat_sink_bounda_fixture_report_2026-05-17.md"
)
