...
# scpn-quantum-control -- Paper 0 Topological Invariants (bk): Determine the structure and richness of the qualia (Betti numbers). fixture runner
"""Run the Paper 0 Topological Invariants (bk): Determine the structure and richness of the qualia (Betti numbers). source-accounting fixture."""
...
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_topological_invariants_bk_determine_the_structure_and_richness_of_the_qu_fixture_report_2026-05-17.md"
)
