...
# scpn-quantum-control -- Paper 0 Axiom II infoton geometry fixture runner
"""Run the Paper 0 Axiom II infoton-geometry source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_infoton_geometry_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_infoton_geometry_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom II Infoton Geometry Fixture",
        "",
        ...
        f"- Gauge-necessity records: {payload['gauge_necessity_count']}",
        f"- Baseline Lagrangian records: {payload['baseline_lagrangian_count']}",
        f"- FIM claim records: {payload['fim_claim_count']}",
