...
# scpn-quantum-control -- Paper 0 foundational strengths and phase boundary fixture runner
"""Run the Paper 0 foundational-strengths and phase-boundary source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_foundational_strengths_phase_boundary_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_foundational_strengths_phase_boundary_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Foundational Strengths Phase Boundary Fixture",
        "",
