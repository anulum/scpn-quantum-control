...
# scpn-quantum-control -- Paper 0 XIII. The Constructive Role of Noise (MSR and NIS) fixture runner
"""Run the Paper 0 XIII. The Constructive Role of Noise (MSR and NIS) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_xiii_the_constructive_role_of_noise_msr_and_nis_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_xiii_the_constructive_role_of_noise_msr_and_nis_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "XIII. The Constructive Role of Noise (MSR and NIS)" + " Fixture",
        "",
