...
# scpn-quantum-control -- Paper 0 Mechanisms of Criticality and Control (Layers 1-4) fixture runner
"""Run the Paper 0 Mechanisms of Criticality and Control (Layers 1-4) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_mechanisms_of_criticality_and_control_layers_1_4_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_mechanisms_of_criticality_and_control_layers_1_4_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Mechanisms of Criticality and Control (Layers 1-4)" + " Fixture",
        "",
