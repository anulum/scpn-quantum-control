...
# scpn-quantum-control -- Paper 0 Axiom II FIM solution fixture runner
"""Run the Paper 0 Axiom II FIM-solution source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_fim_solution_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_ii_fim_solution_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom II FIM Solution Fixture",
        "",
        ...
        f"- Metric-definition records: {payload['metric_definition_count']}",
        f"- Physical-statement records: {payload['physical_statement_count']}",
        f"- Synthesis records: {payload['synthesis_statement_count']}",
