...
# scpn-quantum-control -- Paper 0 IV. The Neuro-Immuno-Endocrine (NIE) Super-System fixture runner
"""Run the Paper 0 IV. The Neuro-Immuno-Endocrine (NIE) Super-System source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_neuro_immuno_endocrine_nie_super_system_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_neuro_immuno_endocrine_nie_super_system_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "IV. The Neuro-Immuno-Endocrine (NIE) Super-System" + " Fixture",
        "",
