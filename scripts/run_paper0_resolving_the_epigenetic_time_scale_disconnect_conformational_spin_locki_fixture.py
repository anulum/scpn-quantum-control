...
# scpn-quantum-control -- Paper 0 Resolving the Epigenetic Time-Scale Disconnect: Conformational Spin-Locking fixture runner
"""Run the Paper 0 Resolving the Epigenetic Time-Scale Disconnect: Conformational Spin-Locking source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_epigenetic_time_scale_disconnect_conformational_spin_locki_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_resolving_the_epigenetic_time_scale_disconnect_conformational_spin_locki_fixture_report_2026-05-17.md"
)
