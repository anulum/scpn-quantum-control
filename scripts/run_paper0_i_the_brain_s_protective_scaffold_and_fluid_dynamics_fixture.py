...
# scpn-quantum-control -- Paper 0 I. The Brain's Protective Scaffold and Fluid Dynamics fixture runner
"""Run the Paper 0 I. The Brain's Protective Scaffold and Fluid Dynamics source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_i_the_brain_s_protective_scaffold_and_fluid_dynamics_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_i_the_brain_s_protective_scaffold_and_fluid_dynamics_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "I. The Brain's Protective Scaffold and Fluid Dynamics" + " Fixture",
        "",
