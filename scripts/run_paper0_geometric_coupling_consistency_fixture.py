...
# scpn-quantum-control -- Paper 0 geometric coupling consistency fixture runner
"""Run the Paper 0 geometric-coupling consistency source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_geometric_coupling_consistency_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_geometric_coupling_consistency_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Geometric Coupling Consistency Fixture",
        "",
        ...
        f"- Math IDs: {payload['math_ids']}",
        f"- Image IDs: {payload['image_ids']}",
        f"- Table IDs: {payload['table_ids']}",
