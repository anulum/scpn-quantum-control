...
# scpn-quantum-control -- Paper 0 The QEC Imperative and the Role of the Psi-Field fixture runner
"""Run the Paper 0 The QEC Imperative and the Role of the Psi-Field source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_qec_imperative_and_the_role_of_the_psi_field_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_qec_imperative_and_the_role_of_the_psi_field_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The QEC Imperative and the Role of the Psi-Field" + " Fixture",
        "",
