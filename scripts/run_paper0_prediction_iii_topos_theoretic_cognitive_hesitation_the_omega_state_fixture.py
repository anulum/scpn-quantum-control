...
# scpn-quantum-control -- Paper 0 Prediction III: Topos-Theoretic Cognitive Hesitation (The $\Omega$-State) fixture runner
r"""Run the Paper 0 Prediction III: Topos-Theoretic Cognitive Hesitation (The $\Omega$-State) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_prediction_iii_topos_theoretic_cognitive_hesitation_the_omega_state_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_prediction_iii_topos_theoretic_cognitive_hesitation_the_omega_state_fixture_report_2026-05-17.md"
)
