...
# scpn-quantum-control -- Paper 0 The Universe's Built-in Moral Compass fixture runner
"""Run the Paper 0 The Universe's Built-in Moral Compass source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_universe_s_built_in_moral_compass_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_universe_s_built_in_moral_compass_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Universe's Built-in Moral Compass" + " Fixture",
        "",
