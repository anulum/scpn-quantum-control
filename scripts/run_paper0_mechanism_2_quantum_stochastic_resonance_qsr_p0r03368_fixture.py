...
# scpn-quantum-control -- Paper 0 Mechanism 2: Quantum Stochastic Resonance (QSR) fixture runner
"""Run the Paper 0 Mechanism 2: Quantum Stochastic Resonance (QSR) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_mechanism_2_quantum_stochastic_resonance_qsr_p0r03368_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_mechanism_2_quantum_stochastic_resonance_qsr_p0r03368_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Mechanism 2: Quantum Stochastic Resonance (QSR)" + " Fixture",
        "",
