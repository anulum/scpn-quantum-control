...
# scpn-quantum-control -- Paper 0 4. The Formal Equivalence of SEC and SC fixture runner
"""Run the Paper 0 4. The Formal Equivalence of SEC and SC source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_4_the_formal_equivalence_of_sec_and_sc_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_4_the_formal_equivalence_of_sec_and_sc_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "4. The Formal Equivalence of SEC and SC" + " Fixture",
        "",
