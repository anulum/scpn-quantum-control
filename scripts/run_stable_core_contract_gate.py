...
# SCPN Quantum Control — run stable core contract gate script
# scpn-quantum-control -- stable core contract fixtures gate
"""Regenerate stable-core contract fixtures and compare against commit."""
...
COMPARATOR_SCRIPT = Path("scripts") / "compare_stable_core_contract_fixtures.py"
...
def build_stable_core_contract_gate_commands(
    *,
