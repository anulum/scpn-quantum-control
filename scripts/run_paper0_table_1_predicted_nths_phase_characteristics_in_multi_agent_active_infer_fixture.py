...
# scpn-quantum-control -- Paper 0 Table 1: Predicted NTHS Phase Characteristics in Multi-Agent Active Inference Simulation fixture runner
"""Run the Paper 0 Table 1: Predicted NTHS Phase Characteristics in Multi-Agent Active Inference Simulation source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_table_1_predicted_nths_phase_characteristics_in_multi_agent_active_infer_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_table_1_predicted_nths_phase_characteristics_in_multi_agent_active_infer_fixture_report_2026-05-17.md"
)
