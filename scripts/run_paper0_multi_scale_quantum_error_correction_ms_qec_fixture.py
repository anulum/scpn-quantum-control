...
# scpn-quantum-control -- Paper 0 Multi-Scale Quantum Error Correction (MS-QEC) fixture runner
"""Run the Paper 0 Multi-Scale Quantum Error Correction (MS-QEC) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_multi_scale_quantum_error_correction_ms_qec_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_multi_scale_quantum_error_correction_ms_qec_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Multi-Scale Quantum Error Correction (MS-QEC)" + " Fixture",
        "",
