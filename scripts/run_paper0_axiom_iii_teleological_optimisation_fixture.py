...
# scpn-quantum-control -- Paper 0 Axiom III teleological optimisation fixture runner
"""Run the Paper 0 Axiom III teleological-optimisation source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_axiom_iii_teleological_optimisation_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_iii_teleological_optimisation_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom III Teleological Optimisation Fixture",
        "",
        ...
        f"- Axiom-heading records: {payload['axiom_heading_count']}",
        f"- SEC-maximisation records: {payload['sec_maximisation_count']}",
        f"- Layer 15 guidance records: {payload['layer15_guidance_count']}",
        f"- Directionality records: {payload['directionality_count']}",
