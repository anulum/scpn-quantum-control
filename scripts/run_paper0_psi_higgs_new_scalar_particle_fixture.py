...
# scpn-quantum-control -- Paper 0 Psi-Higgs new-scalar-particle fixture runner
"""Run the Paper 0 Psi-Higgs new-scalar-particle source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_psi_higgs_new_scalar_particle_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_psi_higgs_new_scalar_particle_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Psi-Higgs New Scalar Particle Fixture",
        "",
