...
# scpn-quantum-control -- Paper 0 BIBO Stability and Lyapunov Certificate: fixture runner
"""Run the Paper 0 BIBO Stability and Lyapunov Certificate: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_bibo_stability_and_lyapunov_certificate_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_bibo_stability_and_lyapunov_certificate_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "BIBO Stability and Lyapunov Certificate:" + " Fixture",
        "",
