...
# scpn-quantum-control -- Paper 0 4.1 The Composite Functional for Causal Path Entropy fixture runner
"""Run the Paper 0 4.1 The Composite Functional for Causal Path Entropy source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_4_1_the_composite_functional_for_causal_path_entropy_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_4_1_the_composite_functional_for_causal_path_entropy_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "4.1 The Composite Functional for Causal Path Entropy" + " Fixture",
        "",
