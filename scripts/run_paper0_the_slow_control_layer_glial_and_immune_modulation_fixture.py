...
# scpn-quantum-control -- Paper 0 The Slow Control Layer - Glial and Immune Modulation fixture runner
"""Run the Paper 0 The Slow Control Layer - Glial and Immune Modulation source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_slow_control_layer_glial_and_immune_modulation_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_slow_control_layer_glial_and_immune_modulation_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Slow Control Layer - Glial and Immune Modulation" + " Fixture",
        "",
