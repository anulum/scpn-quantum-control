...
# scpn-quantum-control -- Paper 0 1. The Mechanism of NVC: fixture runner
"""Run the Paper 0 1. The Mechanism of NVC: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_section_1_the_mechanism_of_nvc_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_section_1_the_mechanism_of_nvc_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "1. The Mechanism of NVC:" + " Fixture",
        "",
