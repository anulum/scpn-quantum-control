...
# scpn-quantum-control -- Paper 0 VI. Clinical Implications: Pathology and Therapeutics fixture runner
"""Run the Paper 0 VI. Clinical Implications: Pathology and Therapeutics source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_vi_clinical_implications_pathology_and_therapeutics_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_vi_clinical_implications_pathology_and_therapeutics_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "VI. Clinical Implications: Pathology and Therapeutics" + " Fixture",
        "",
