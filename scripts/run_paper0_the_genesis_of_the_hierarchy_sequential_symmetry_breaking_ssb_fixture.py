...
# scpn-quantum-control -- Paper 0 The Genesis of the Hierarchy: Sequential Symmetry Breaking (SSB) fixture runner
"""Run the Paper 0 The Genesis of the Hierarchy: Sequential Symmetry Breaking (SSB) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_genesis_of_the_hierarchy_sequential_symmetry_breaking_ssb_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_genesis_of_the_hierarchy_sequential_symmetry_breaking_ssb_fixture_report_2026-05-17.md"
)
