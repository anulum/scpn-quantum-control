...
# scpn-quantum-control -- Paper 0 2.3. The Ethical Lagrangian as the Yang-Mills Action fixture runner
"""Run the Paper 0 2.3. The Ethical Lagrangian as the Yang-Mills Action source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_3_the_ethical_lagrangian_as_the_yang_mills_action_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_3_the_ethical_lagrangian_as_the_yang_mills_action_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2.3. The Ethical Lagrangian as the Yang-Mills Action" + " Fixture",
        "",
