...
# scpn-quantum-control -- Paper 0 Biological QEC (L1-4): fixture runner
"""Run the Paper 0 Biological QEC (L1-4): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_biological_qec_l1_4_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_biological_qec_l1_4_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Biological QEC (L1-4):" + " Fixture",
        "",
