...
# scpn-quantum-control -- Paper 0 3. Sleep and Dreaming (The Optimisation Cycle): fixture runner
"""Run the Paper 0 3. Sleep and Dreaming (The Optimisation Cycle): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_sleep_and_dreaming_the_optimisation_cycle_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_sleep_and_dreaming_the_optimisation_cycle_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "3. Sleep and Dreaming (The Optimisation Cycle):" + " Fixture",
        "",
