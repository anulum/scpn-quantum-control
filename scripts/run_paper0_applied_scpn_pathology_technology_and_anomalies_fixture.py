...
# scpn-quantum-control -- Paper 0 Applied SCPN: Pathology, Technology, and Anomalies fixture runner
"""Run the Paper 0 Applied SCPN: Pathology, Technology, and Anomalies source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_applied_scpn_pathology_technology_and_anomalies_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_applied_scpn_pathology_technology_and_anomalies_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Applied SCPN: Pathology, Technology, and Anomalies" + " Fixture",
        "",
