...
# scpn-quantum-control -- Paper 0  Systems Neuroscience & Complexity fixture runner
"""Run the Paper 0  Systems Neuroscience & Complexity source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_systems_neuroscience_complexity_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_systems_neuroscience_complexity_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + " Systems Neuroscience & Complexity" + " Fixture",
        "",
