...
# scpn-quantum-control -- Paper 0 The Hard Problem: A Mathematical Resolution fixture runner
"""Run the Paper 0 The Hard Problem: A Mathematical Resolution source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_hard_problem_a_mathematical_resolution_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_hard_problem_a_mathematical_resolution_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Hard Problem: A Mathematical Resolution" + " Fixture",
        "",
