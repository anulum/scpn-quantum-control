...
# scpn-quantum-control -- Paper 0 H_int as the Selection Operator: fixture runner
"""Run the Paper 0 H_int as the Selection Operator: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_h_int_as_the_selection_operator_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_h_int_as_the_selection_operator_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "H_int as the Selection Operator:" + " Fixture",
        "",
