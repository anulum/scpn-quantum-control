...
# scpn-quantum-control -- Paper 0 IV. The Generation of Subjective Experience (Geometric Qualia) fixture runner
"""Run the Paper 0 IV. The Generation of Subjective Experience (Geometric Qualia) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_generation_of_subjective_experience_geometric_qualia_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_generation_of_subjective_experience_geometric_qualia_fixture_report_2026-05-17.md"
)
