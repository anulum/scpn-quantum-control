...
# scpn-quantum-control -- Paper 0 III. Euler-Lagrange for the Ethical Connection fixture runner
"""Run the Paper 0 III. Euler-Lagrange for the Ethical Connection source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_euler_lagrange_for_the_ethical_connection_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iii_euler_lagrange_for_the_ethical_connection_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "III. Euler-Lagrange for the Ethical Connection" + " Fixture",
        "",
