...
# scpn-quantum-control -- Paper 0 The Locus of the Interaction: fixture runner
"""Run the Paper 0 The Locus of the Interaction: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_the_locus_of_the_interaction_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_the_locus_of_the_interaction_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Locus of the Interaction:" + " Fixture",
        "",
