...
# scpn-quantum-control -- Paper 0 Axiom I SU(N) qualia fixture runner
"""Run the Paper 0 Axiom I SU(N) qualia source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_i_su_n_qualia_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_axiom_i_su_n_qualia_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Axiom I SU(N) Qualia Confinement Fixture",
        "",
        ...
        f"- Example linear potential: {payload['example_linear_potential']}",
    ...
    lines.extend(["", "## Example Info-Gluon Counts"])
    for key, value in payload["example_info_gluon_counts"].items():
