...
# scpn-quantum-control -- Paper 0 category universal grammar fixture runner
"""Run the Paper 0 category/universal-grammar source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_category_universal_grammar_fixture_result_2026-05-13.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_category_universal_grammar_fixture_report_2026-05-13.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Category Universal Grammar Fixture",
        "",
        ...
        f"- Formal-category records: {payload['formal_category_record_count']}",
        f"- Meta-framework records: {payload['meta_framework_record_count']}",
        f"- Image records: {payload['image_record_count']}",
        f"- Figure / caption records: {payload['figure_caption_record_count']}",
