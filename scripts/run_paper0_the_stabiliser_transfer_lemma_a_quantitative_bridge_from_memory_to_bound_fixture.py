...
# scpn-quantum-control -- Paper 0 The Stabiliser Transfer Lemma: A Quantitative Bridge from Memory to Boundary fixture runner
"""Run the Paper 0 The Stabiliser Transfer Lemma: A Quantitative Bridge from Memory to Boundary source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_stabiliser_transfer_lemma_a_quantitative_bridge_from_memory_to_bound_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_stabiliser_transfer_lemma_a_quantitative_bridge_from_memory_to_bound_fixture_report_2026-05-17.md"
)
