...
# scpn-quantum-control -- Paper 0 VII. Field Generation and Upward Causality (Topological Defects) fixture runner
"""Run the Paper 0 VII. Field Generation and Upward Causality (Topological Defects) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_vii_field_generation_and_upward_causality_topological_defects_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_vii_field_generation_and_upward_causality_topological_defects_fixture_report_2026-05-17.md"
)
