...
# scpn-quantum-control -- Paper 0 3.1 Complexity (K) and the Cardinality of the State Space fixture runner
"""Run the Paper 0 3.1 Complexity (K) and the Cardinality of the State Space source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_1_complexity_k_and_the_cardinality_of_the_state_space_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_1_complexity_k_and_the_cardinality_of_the_state_space_fixture_report_2026-05-17.md"
)
