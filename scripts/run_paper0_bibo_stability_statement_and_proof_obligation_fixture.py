...
# scpn-quantum-control -- Paper 0 BIBO stability (statement and proof obligation). fixture runner
"""Run the Paper 0 BIBO stability (statement and proof obligation). source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_bibo_stability_statement_and_proof_obligation_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_bibo_stability_statement_and_proof_obligation_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "BIBO stability (statement and proof obligation)." + " Fixture",
        "",
