...
# scpn-quantum-control -- Paper 0 Axionphoton mixing with the plasma term. fixture runner
"""Run the Paper 0 Axionphoton mixing with the plasma term. source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_axion_photon_mixing_with_the_plasma_term_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_axion_photon_mixing_with_the_plasma_term_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Axionphoton mixing with the plasma term." + " Fixture",
        "",
