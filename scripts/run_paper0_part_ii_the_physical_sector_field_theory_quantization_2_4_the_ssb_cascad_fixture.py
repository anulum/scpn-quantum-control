...
# scpn-quantum-control -- Paper 0 Part II: The Physical Sector (Field Theory & Quantization) > 2.4 The SSB Cascade: Origin of Mass & The Solitonic Self > The "Self" as a Soliton: Emergence of Localised Consciousness (Layer 5) > The Definition of the Self: The Triadic Solution fixture runner
"""Run the Paper 0 Part II: The Physical Sector (Field Theory & Quantization) > 2.4 The SSB Cascade: Origin of Mass & The Solitonic Self > The "Self" as a Soliton: Emergence of Localised Consciousness (Layer 5) > The Definition of the Self: The Triadic Solution source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_part_ii_the_physical_sector_field_theory_quantization_2_4_the_ssb_cascad_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_part_ii_the_physical_sector_field_theory_quantization_2_4_the_ssb_cascad_fixture_report_2026-05-17.md"
)
