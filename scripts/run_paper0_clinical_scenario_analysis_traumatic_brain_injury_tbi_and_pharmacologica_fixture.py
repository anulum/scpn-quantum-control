...
# scpn-quantum-control -- Paper 0 Clinical Scenario Analysis: Traumatic Brain Injury (TBI) and Pharmacological Intervention fixture runner
"""Run the Paper 0 Clinical Scenario Analysis: Traumatic Brain Injury (TBI) and Pharmacological Intervention source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_clinical_scenario_analysis_traumatic_brain_injury_tbi_and_pharmacologica_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_clinical_scenario_analysis_traumatic_brain_injury_tbi_and_pharmacologica_fixture_report_2026-05-17.md"
)
