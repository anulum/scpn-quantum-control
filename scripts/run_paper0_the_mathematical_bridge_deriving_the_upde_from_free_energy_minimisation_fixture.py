...
# scpn-quantum-control -- Paper 0 The Mathematical Bridge: Deriving the UPDE from Free Energy Minimisation fixture runner
"""Run the Paper 0 The Mathematical Bridge: Deriving the UPDE from Free Energy Minimisation source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_mathematical_bridge_deriving_the_upde_from_free_energy_minimisation_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_mathematical_bridge_deriving_the_upde_from_free_energy_minimisation_fixture_report_2026-05-17.md"
)
