...
# scpn-quantum-control -- Paper 0 Formalism of the Homeostatic Quasicritical Controller fixture runner
"""Run the Paper 0 Formalism of the Homeostatic Quasicritical Controller source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_formalism_of_the_homeostatic_quasicritical_controller_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_formalism_of_the_homeostatic_quasicritical_controller_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Formalism of the Homeostatic Quasicritical Controller" + " Fixture",
        "",
