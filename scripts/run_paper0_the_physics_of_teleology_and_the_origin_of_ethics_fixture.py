...
# scpn-quantum-control -- Paper 0 The Physics of Teleology and the Origin of Ethics fixture runner
"""Run the Paper 0 The Physics of Teleology and the Origin of Ethics source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_physics_of_teleology_and_the_origin_of_ethics_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_physics_of_teleology_and_the_origin_of_ethics_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Physics of Teleology and the Origin of Ethics" + " Fixture",
        "",
