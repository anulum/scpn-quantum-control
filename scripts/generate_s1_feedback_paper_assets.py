...
RUN_ROWS = (
    ("S1b original", "s1b_xy_observable_analysis_ibm_kingston_20260520T130238Z.json", None),
    ("S1c shallow", "s1c_xy_observable_analysis_ibm_kingston_20260520T132455Z.json", None),
    (
        "S1d current",
        "s1d_xy_observable_analysis_ibm_kingston_20260520T134614Z.json",
    ...
    ("S1d weak", "s1d_xy_observable_analysis_ibm_kingston_20260520T134614Z.json", "weak_positive"),
    (
        "S1e current",
        "s1e_xy_observable_analysis_ibm_kingston_20260520T140919Z.json",
        "current_shallow_positive",
    ),
    (
        "S1e flipped",
    ...
    ("S1e weak", "s1e_xy_observable_analysis_ibm_kingston_20260520T140919Z.json", "weak_positive"),
    ("S1f quadrature", "s1f_xy_observable_analysis_ibm_kingston_20260520T142213Z.json", None),
)
...
def build_matrix(data_dir: Path) -> tuple[list[str], list[str], np.ndarray]:
    ...
    for row_label, filename, variant in RUN_ROWS:
...
def main() -> int:
    args = parse_args()
    rows, columns, matrix = build_matrix(args.data_dir)
    outputs = write_heatmap(rows, columns, matrix, args.figure_dir)
