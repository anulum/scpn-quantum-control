...
# scpn-quantum-control -- Paper 0 The Central Hubs of Binding: Orchestrating Unity fixture runner
"""Run the Paper 0 The Central Hubs of Binding: Orchestrating Unity source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_central_hubs_of_binding_orchestrating_unity_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_central_hubs_of_binding_orchestrating_unity_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Central Hubs of Binding: Orchestrating Unity" + " Fixture",
        "",
