...
# scpn-quantum-control -- Paper 0 One Spine, Many Couplings - UPDE Scope Constraint fixture runner
"""Run the Paper 0 One Spine, Many Couplings - UPDE Scope Constraint source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_one_spine_many_couplings_upde_scope_constraint_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_one_spine_many_couplings_upde_scope_constraint_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "One Spine, Many Couplings - UPDE Scope Constraint" + " Fixture",
        "",
