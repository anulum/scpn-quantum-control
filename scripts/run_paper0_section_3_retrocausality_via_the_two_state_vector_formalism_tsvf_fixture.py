...
# scpn-quantum-control -- Paper 0 3. Retrocausality via the Two-State Vector Formalism (TSVF): fixture runner
"""Run the Paper 0 3. Retrocausality via the Two-State Vector Formalism (TSVF): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_retrocausality_via_the_two_state_vector_formalism_tsvf_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_retrocausality_via_the_two_state_vector_formalism_tsvf_fixture_report_2026-05-17.md"
)
