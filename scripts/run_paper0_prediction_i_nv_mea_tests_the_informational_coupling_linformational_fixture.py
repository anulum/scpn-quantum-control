...
# scpn-quantum-control -- Paper 0 Prediction I (NV-MEA) Tests the Informational Coupling (LInformational): fixture runner
"""Run the Paper 0 Prediction I (NV-MEA) Tests the Informational Coupling (LInformational): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_prediction_i_nv_mea_tests_the_informational_coupling_linformational_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_prediction_i_nv_mea_tests_the_informational_coupling_linformational_fixture_report_2026-05-17.md"
)
