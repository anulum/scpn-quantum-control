...
# scpn-quantum-control -- Paper 0 Qualia as the Geometry of Belief: fixture runner
"""Run the Paper 0 Qualia as the Geometry of Belief: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_qualia_as_the_geometry_of_belief_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_qualia_as_the_geometry_of_belief_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "Qualia as the Geometry of Belief:" + " Fixture",
        "",
