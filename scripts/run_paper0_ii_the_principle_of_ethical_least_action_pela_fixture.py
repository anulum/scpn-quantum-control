...
# scpn-quantum-control -- Paper 0 II. The Principle of Ethical Least Action (PELA) fixture runner
"""Run the Paper 0 II. The Principle of Ethical Least Action (PELA) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_principle_of_ethical_least_action_pela_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_ii_the_principle_of_ethical_least_action_pela_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "II. The Principle of Ethical Least Action (PELA)" + " Fixture",
        "",
