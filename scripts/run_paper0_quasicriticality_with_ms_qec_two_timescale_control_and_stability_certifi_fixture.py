...
# scpn-quantum-control -- Paper 0 Quasicriticality with MS-QEC: Two-Timescale Control and Stability Certificates (revision 11.07) fixture runner
"""Run the Paper 0 Quasicriticality with MS-QEC: Two-Timescale Control and Stability Certificates (revision 11.07) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_quasicriticality_with_ms_qec_two_timescale_control_and_stability_certifi_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_quasicriticality_with_ms_qec_two_timescale_control_and_stability_certifi_fixture_report_2026-05-17.md"
)
