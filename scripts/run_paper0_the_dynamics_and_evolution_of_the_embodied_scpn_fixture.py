...
# scpn-quantum-control -- Paper 0 The Dynamics and Evolution of the Embodied SCPN fixture runner
"""Run the Paper 0 The Dynamics and Evolution of the Embodied SCPN source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_dynamics_and_evolution_of_the_embodied_scpn_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_the_dynamics_and_evolution_of_the_embodied_scpn_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Dynamics and Evolution of the Embodied SCPN" + " Fixture",
        "",
