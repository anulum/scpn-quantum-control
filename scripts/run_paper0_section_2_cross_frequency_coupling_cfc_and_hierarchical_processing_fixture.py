...
# scpn-quantum-control -- Paper 0 2. Cross-Frequency Coupling (CFC) and Hierarchical Processing: fixture runner
"""Run the Paper 0 2. Cross-Frequency Coupling (CFC) and Hierarchical Processing: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_cross_frequency_coupling_cfc_and_hierarchical_processing_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_cross_frequency_coupling_cfc_and_hierarchical_processing_fixture_report_2026-05-17.md"
)
