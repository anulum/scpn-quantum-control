...
# scpn-quantum-control -- Paper 0 5.1 The Modified Path Integral with CEF Weighting fixture runner
"""Run the Paper 0 5.1 The Modified Path Integral with CEF Weighting source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_5_1_the_modified_path_integral_with_cef_weighting_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_5_1_the_modified_path_integral_with_cef_weighting_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "5.1 The Modified Path Integral with CEF Weighting" + " Fixture",
        "",
