...
# scpn-quantum-control -- Paper 0 1. Propofol (GABA-A Potentiation): fixture runner
"""Run the Paper 0 1. Propofol (GABA-A Potentiation): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_1_propofol_gaba_a_potentiation_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_1_propofol_gaba_a_potentiation_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "1. Propofol (GABA-A Potentiation):" + " Fixture",
        "",
