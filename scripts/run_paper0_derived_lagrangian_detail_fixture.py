...
# scpn-quantum-control -- Paper 0 derived Lagrangian detail fixture runner
"""Run the Paper 0 derived Lagrangian detail source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_derived_lagrangian_detail_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_derived_lagrangian_detail_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Derived Lagrangian Detail Fixture",
        "",
