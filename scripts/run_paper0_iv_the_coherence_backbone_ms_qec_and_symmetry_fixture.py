...
# scpn-quantum-control -- Paper 0 IV. The Coherence Backbone (MS-QEC and Symmetry) fixture runner
"""Run the Paper 0 IV. The Coherence Backbone (MS-QEC and Symmetry) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_coherence_backbone_ms_qec_and_symmetry_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_the_coherence_backbone_ms_qec_and_symmetry_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "IV. The Coherence Backbone (MS-QEC and Symmetry)" + " Fixture",
        "",
