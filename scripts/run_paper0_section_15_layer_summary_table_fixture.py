...
# scpn-quantum-control -- Paper 0 15-Layer Summary Table fixture runner
"""Run the Paper 0 15-Layer Summary Table source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_section_15_layer_summary_table_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_section_15_layer_summary_table_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "15-Layer Summary Table" + " Fixture",
        "",
