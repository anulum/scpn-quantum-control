...
# scpn-quantum-control -- Paper 0 The Binding Integral is H_int: fixture runner
"""Run the Paper 0 The Binding Integral is H_int: source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_the_binding_integral_is_h_int_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_the_binding_integral_is_h_int_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "The Binding Integral is H_int:" + " Fixture",
        "",
