...
# scpn-quantum-control -- Paper 0 I. The Unified Mathematical Description (The Dynamic Fiber Bundle) fixture runner
"""Run the Paper 0 I. The Unified Mathematical Description (The Dynamic Fiber Bundle) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_i_the_unified_mathematical_description_the_dynamic_fiber_bundle_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_i_the_unified_mathematical_description_the_dynamic_fiber_bundle_fixture_report_2026-05-17.md"
)
