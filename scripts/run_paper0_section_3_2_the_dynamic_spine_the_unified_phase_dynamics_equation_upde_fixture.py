...
# scpn-quantum-control -- Paper 0 3.2 The Dynamic Spine: The Unified Phase Dynamics Equation (UPDE) fixture runner
"""Run the Paper 0 3.2 The Dynamic Spine: The Unified Phase Dynamics Equation (UPDE) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_2_the_dynamic_spine_the_unified_phase_dynamics_equation_upde_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_3_2_the_dynamic_spine_the_unified_phase_dynamics_equation_upde_fixture_report_2026-05-17.md"
)
