...
# scpn-quantum-control -- Paper 0 final LInt SM interface fixture runner
"""Run the Paper 0 final LInt and Standard Model interface source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_final_lint_sm_interface_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR / "paper0_final_lint_sm_interface_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 Final LInt SM Interface Fixture",
        "",
