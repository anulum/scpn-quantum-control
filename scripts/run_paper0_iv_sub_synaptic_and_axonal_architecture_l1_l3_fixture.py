...
# scpn-quantum-control -- Paper 0 IV. Sub-Synaptic and Axonal Architecture (L1-L3) fixture runner
"""Run the Paper 0 IV. Sub-Synaptic and Axonal Architecture (L1-L3) source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_sub_synaptic_and_axonal_architecture_l1_l3_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_sub_synaptic_and_axonal_architecture_l1_l3_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "IV. Sub-Synaptic and Axonal Architecture (L1-L3)" + " Fixture",
        "",
