...
# scpn-quantum-control -- Paper 0 IV. Ethics as Causal Entropic Forces (CEF): fixture runner
"""Run the Paper 0 IV. Ethics as Causal Entropic Forces (CEF): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_ethics_as_causal_entropic_forces_cef_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_iv_ethics_as_causal_entropic_forces_cef_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "IV. Ethics as Causal Entropic Forces (CEF):" + " Fixture",
        "",
