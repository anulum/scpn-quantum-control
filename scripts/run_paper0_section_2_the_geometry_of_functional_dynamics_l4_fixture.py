...
# scpn-quantum-control -- Paper 0 2. The Geometry of Functional Dynamics (L4): fixture runner
"""Run the Paper 0 2. The Geometry of Functional Dynamics (L4): source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_geometry_of_functional_dynamics_l4_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_the_geometry_of_functional_dynamics_l4_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2. The Geometry of Functional Dynamics (L4):" + " Fixture",
        "",
