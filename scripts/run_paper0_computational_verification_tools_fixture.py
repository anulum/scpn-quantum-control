...
# scpn-quantum-control -- Paper 0 computational verification fixture runner
"""Run the Paper 0 computational verification tools fixture."""
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    return (
        "# Paper 0 Computational Verification Tools Fixture\n\n"
...
def write_outputs(
    *,
    ...
    result = validate_computational_verification_tools_fixture(
        ComputationalVerificationToolsConfig(spec_bundle_path=spec_bundle_path)
    )
...
def main() -> int:
    """Run the default computational verification tools fixture."""
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument(
        "--output",
        type=Path,
        default=DEFAULT_EXTRACTION_DIR
        / "paper0_computational_verification_tools_fixture_result_2026-05-13.json",
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=DEFAULT_EXTRACTION_DIR
        / "paper0_computational_verification_tools_fixture_report_2026-05-13.md",
    )
