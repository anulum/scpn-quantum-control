...
# scpn-quantum-control -- Paper 0 2. Dendritic Spines: The Loci of Plasticity and IET fixture runner
"""Run the Paper 0 2. Dendritic Spines: The Loci of Plasticity and IET source-accounting fixture."""
...
DEFAULT_OUTPUT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_dendritic_spines_the_loci_of_plasticity_and_iet_fixture_result_2026-05-17.json"
)
DEFAULT_REPORT_PATH = (
    DEFAULT_OUTPUT_DIR
    / "paper0_section_2_dendritic_spines_the_loci_of_plasticity_and_iet_fixture_report_2026-05-17.md"
)
...
def render_report(payload: dict[str, Any]) -> str:
    ...
    lines = [
        "# Paper 0 " + "2. Dendritic Spines: The Loci of Plasticity and IET" + " Fixture",
        "",
