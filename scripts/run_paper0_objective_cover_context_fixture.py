...
# scpn-quantum-control -- Paper 0 objective cover context runner
"""Run the Paper 0 objective cover context validation fixture."""
...
def render_report(payload: dict[str, Any]) -> str:
    """Render a compact Markdown report for the objective cover context fixture."""
    return "\n".join(
        [
            "# Paper 0 Objective Cover Context Fixture",
            "",
            ...
            f"- Positioning Preface boundary: {payload['positioning_preface_boundary']}",
...
def main() -> int:
    """Run the objective cover context fixture and write artefacts."""
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument(
        "--output",
        type=Path,
        default=DEFAULT_OUTPUT_DIR
        / "paper0_objective_cover_context_fixture_result_2026-05-13.json",
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=DEFAULT_OUTPUT_DIR / "paper0_objective_cover_context_fixture_report_2026-05-13.md",
    )
