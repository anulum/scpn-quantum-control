...
| `scpn_quantum_control.neural_operator_baseline_product` | BL-78 classical neural-operator baseline composition: verifies committed runner arithmetic/digest, separates training and inference labels, binds BL-65 no-advantage, admits public/synthetic datasets, and records BL-32/37 wiring residuals. See [Neural-operator baseline product](neural_operator_baseline_product.md). |
