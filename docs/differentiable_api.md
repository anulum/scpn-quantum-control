...
| `scpn_quantum_control.wirtinger_implicit_product` | BL-64 Wirtinger + implicit differentiation product: Wirtinger/holomorphic/CR catalogue, implicit stationary/fixed-point demos, refuse complex without Wirtinger (BL-53/BL-46). See [Wirtinger + implicit product](wirtinger_implicit_product.md). |
