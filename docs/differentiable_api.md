...
| `scpn_quantum_control.analysis.adaptive_fim_feedback` | BL-80 uncertainty-aware batch-level FIM next-experiment proposals: disjoint count witnesses, Wilson intervals, minimum-shot and bounded-delta gates, BL-47 complete paired-arm budget approval, and BL-33 observer/unapplied-proposal ports. The legacy point-estimate helper is compatibility-only; hardware, closed-loop efficacy, protection, optimal-policy, and advantage claims fail closed. See [adaptive FIM feedback](adaptive_fim_feedback.md). |
