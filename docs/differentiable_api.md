...
| `scpn_quantum_control.phase.qnode_circuit` | Executable facade over the shared contract, builder, and support leaves for parameter-shift gradients, statevector/density execution, exact and finite-shot Fisher metrics, QFI/Fubini-Study metrics, natural-gradient providers, and numerical state/density/observable kernels. |
