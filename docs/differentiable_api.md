...
| `scpn_quantum_control.campaign_harness_product` | BL-99 campaign harness productisation: AppQSim / IQM layout-transfer / closed-loop publication / ambient registry templates with digests, no-submit dry-run probes; refuse invent-green live submit / unattested claims. See [campaign harness product](campaign_harness_product.md). |
