...
| `scpn_quantum_control.program_ad_fuzz_assurance` | Rust Program AD fuzz assurance: target catalogue over ambient cargo-fuzz bins, time-boxed CI-optional policy, dry-run refuse invent-green continuous coverage. See [Program AD fuzz assurance](program_ad_fuzz_assurance.md). |
