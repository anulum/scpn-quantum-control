...
| `scpn_quantum_control.qpu_compute_product` | BL-95 qpu_compute plan product: typed dry-run plan kinds, fail-closed unknown ids, refuse would-live/hardware_enabled, BL-47-aligned secret-free audit. See [qpu_compute product](qpu_compute_product.md). |
