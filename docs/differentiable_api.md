...
| `scpn_quantum_control.studio_executive_product` | BL-62 Studio executive + coverage frontier product: verb→route catalogue (BL-52/53), honesty×answer-rate frontier probe, refuse invent-green full coverage / unapproved execute. See [studio executive product](studio_executive_product.md). |
