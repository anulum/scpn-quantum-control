...
| `scpn_quantum_control.custom_derivatives_product` | BL-92 custom/registered derivatives product: registration contract, fail-closed register/query, scaled-linear example rule; transform-algebra CI residual. See [custom derivatives product](custom_derivatives_product.md). |
