...
| `scpn_quantum_control.error_mitigation_product` | BL-59 differentiable error-mitigation taxonomy product: mitigator differentiability classes + local ZNE/readout probes over ambient mitigation/*; refuse invent-green ideal-gradient restore / live QPU / mitiq hard-dep. See [error mitigation product](error_mitigation_product.md). |
