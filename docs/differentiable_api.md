...
| `scpn_quantum_control.polyglot_parity_certificate` | BL-49 bit-exact polyglot parity certificates: family catalogue, schema v1 digests, build/verify fail-closed unsupported paths; no full NumPy parity claim. See [polyglot parity certificates](polyglot_parity_certificate.md). |
