...
| `scpn_quantum_control.phase.qnode_circuit` | Executable facade over the shared contract, builder, support, and execution leaves for parameter-shift gradients, derivative propagation, exact and finite-shot Fisher metrics, QFI/Fubini-Study metrics, and natural-gradient providers. |
