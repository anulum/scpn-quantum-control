...
| `scpn_quantum_control.phase_qnode_product` | BL-90 Phase-QNode product surface: versioned journey map (build→differentiate→dry-run), support badges, fail-closed unknown ids, refuse invent-green hardware; workbench not SemVer-frozen (BL-97). See [Phase-QNode product](phase_qnode_product.md). |
