...
PyTorch runtime passes a real CUDA smoke. Incompatible CUDA, durable checkpoint
portability, provider, hardware, isolated benchmark, and performance promotion
remain blocked.
