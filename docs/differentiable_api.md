...
| `scpn_quantum_control.notebook_programme_product` | BL-40 differentiable notebook programme product: core-six curriculum catalogue under notebooks/differentiable, hardware_execution=false, refuse invent-green QPU/archive conversion. See [notebook programme product](notebook_programme_product.md). |
