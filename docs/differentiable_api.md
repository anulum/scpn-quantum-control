...
| `scpn_quantum_control.geometric_control_product` | BL-50 geometric quantum control product: QFI/McLachlan/QNG catalogue, metric spectrum diagnostics, regularised NGD probe over ambient variational_metric + natural_gradient; refuse invent-green advantage at criticality / live QPU. See [geometric control product](geometric_control_product.md). |
