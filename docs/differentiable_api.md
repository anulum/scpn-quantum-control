...
| `scpn_quantum_control.control_stack_compose_product` | BL-67 compose existing control/* stack product: ownership map + typed adapter ports over ambient control/realtime/closed-loop/hardware feedback; refuse evaluate without ExecutionPolicy, invent-green PCS, realtime_runtime rewrites. See [control stack compose product](control_stack_compose_product.md). |
