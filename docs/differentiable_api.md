...
| `scpn_quantum_control.attested_result_pack` | Attested result packs: canonical digest over content bound to claim axes, local unsigned envelope, verify statuses VERIFIED/STRIPPED/FORGED/UNGRADED (never silent-validated). See [Attested result pack](attested_result_pack.md). |
