...
| `scpn_quantum_control.quantum_sync_challenge_oracle_product` | BL-32 Quantum Sync Challenge oracle product: families F1–F4 + hardware schema, metrics/baselines, anti-cheat digests, ambient witness suite probe; refuse invent-green advantage / unvalidated ranks / hardware auto-exec. See [sync challenge oracle product](quantum_sync_challenge_oracle_product.md). |
