...
| `scpn_quantum_control.advanced_witnesses_product` | BL-44 advanced witnesses product: Krylov/OTOC/classical-shadow catalogue + WitnessEstimate provenance over ambient analysis/*; hard qubit/shot caps; refuse invent-green OTOC advantage / topology cert / live QPU / unrestricted shadows; compose BL-18. See [advanced witnesses product](advanced_witnesses_product.md). |
