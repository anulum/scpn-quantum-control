...
| `scpn_quantum_control.competitive_baseline_watch` | BL-61 continuous competitive baseline watch: pinned-snapshot inventory from competitive baselines, fail-closed refresh/feed probes (no invent-green BL-56 promotion; BL-52 pointer-only). See [Competitive baseline watch](competitive_baseline_watch.md). |
