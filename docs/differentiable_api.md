...
| `scpn_quantum_control.adjoint_replay_product` | BL-39 adjoint reversible simulator replay product: reverse Program AD adjoint + executable step replay catalogue, checkpoint policy, refuse mid-circuit/Catalyst/hardware invent-green. See [adjoint replay product](adjoint_replay_product.md). |
