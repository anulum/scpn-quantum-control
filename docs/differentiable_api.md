...
| `scpn_quantum_control.migration_guides_product` | BL-41 PennyLane + Qiskit migration guides product: concept-map catalogue, local PL import round-trip and Qiskit Statevector parameter-shift demos, refuse live Runtime / full parity invent-green. See [migration guides product](migration_guides_product.md). |
