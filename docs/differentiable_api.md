...
`ExportedProgram` artifact metadata, and keeps dynamic-shape constraints and
dynamic-shape replay blocked until a constrained input-driven export exists.
