...
and replays strict module plus Adam optimizer state. Incompatible CUDA,
cross-runtime checkpoint portability, provider, hardware, isolated benchmark,
