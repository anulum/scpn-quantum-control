...
| `scpn_quantum_control.open_system_mcwf_product` | BL-51 open-system MCWF completeness product: Lindblad/MCWF surfaces, seeded ensemble certificates, sim noise I/O over ambient tensor_jump + open_system_objectives; refuse invent-green hardware noise / adjoint Lindblad / non-Markovian process tensor. See [open-system MCWF product](open_system_mcwf_product.md). |
