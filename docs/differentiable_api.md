...
eigenvalues/nonzero-offdiagonal eigenvectors, and 2x2 real-distinct `eigvals`
replay. Metadata
...
bounded 2x2 real-distinct `np.linalg.eigvals` output replay, static source-map
...
adjoints beyond the bounded 2x2 `eigvalsh`, `eigh`, and `eigvals` boundaries, unsafe source-level aliases and non-executed branch
...
replay, and bounded 2x2 real-distinct `np.linalg.eigvals` spectral replay,
