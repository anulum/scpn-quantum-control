...
| `scpn_quantum_control.whole_program_ad_product` | BL-91 Whole-program AD product surface: versioned frontend→IR→adjoint journey map, architecture layers, fail-closed unknown ids, unsupported frontend→BL-53, refuse invent-green hardware/polyglot/edge; workbench not SemVer-frozen (BL-97). See [Whole-program AD product](whole_program_ad_product.md). |
