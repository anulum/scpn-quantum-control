...
| `scpn_quantum_control.thermo_readiness_product` | BL-100 thermodynamics readiness product: S9 claim-bounded K-sweep/readiness over ambient `thermodynamics.readiness`, FEP research-only inventory (BL-84); refuse invent-green peak claim / hardware submit / FEP product promotion. See [thermo readiness product](thermo_readiness_product.md). |
