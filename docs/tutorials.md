...
| Studio federation | [Studio Federation](studio_federation.md) | `scpn-emit-studio-manifest --help` |
...
the gated runner is configured; and Studio manifests and bundles describe
evidence already owned by this repository.
...
functions, await expressions, async iteration, generator functions, context
managers, exception control flow, and decorators fail closed before objective
execution.
