...
# scpn-quantum-control — Paper Claims: Quantum Simulation of Kuramoto Phase Dynamics on NISQ Hardware
...
Full draft: [`paper/submissions/submission_002_phase1_dla_parity/phase1_dla_parity_short_paper.md`](https://github.com/anulum/scpn-quantum-control/blob/main/paper/submissions/submission_002_phase1_dla_parity/phase1_dla_parity_short_paper.md)
