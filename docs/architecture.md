...
| Rust crate | 1 (PyO3 0.29, **177 bindings**, 62 Rust source files including `validation.rs`, `symmetry_decay.rs`, `community.rs`, `pulse_shaping.rs`) |
...
└── src/lib.rs                                 177 PyO3 bindings across 62 source files, including: kuramoto_euler, kuramoto_trajectory,
