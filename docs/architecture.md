...
| Metric | Count |
|--------|-------|
| Python modules | 702 (excluding package initialisers) |
...
├── entanglement_enhanced_sync.py            Initial-state/coherence controls; no K_c claim (Gem 7)
...
└── src/lib.rs                                 177 PyO3 bindings across 85 source files, including: kuramoto_euler, kuramoto_trajectory,
