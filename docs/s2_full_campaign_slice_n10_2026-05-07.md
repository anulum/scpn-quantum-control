...
- JSON summary: `data/s2_advantage_scaling/s2_full_campaign_slice_n10_2026-05-07.json`
- Executed rows: `data/s2_advantage_scaling/s2_full_campaign_slice_rows_n10_2026-05-07.csv`
