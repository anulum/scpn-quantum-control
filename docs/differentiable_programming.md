...
2x2 distinct symmetric `eigvalsh` replay. Rust
...
remaining broad linalg/spectral adjoints beyond the 2x2 `eigvalsh` boundary,
...
fixed-signature `np.linalg.multi_dot` linalg-array output replay, and bounded
2x2 distinct symmetric `np.linalg.eigvalsh` spectral replay. The legacy
