...
2. open-system and inverse-coupling differentiable objectives that extend the current bounded ground-state optimizer and phase-QNN convergence evidence;
