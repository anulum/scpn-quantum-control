...
page maps the five DP-015 criticisms and seven DP-030 evidence-package rows to
...
| Reviewer evidence index | Generated from typed DP-015/030 rows; validates commands, repository paths, changelog markers, support-matrix counts, capability-manifest surfaces, and public open-gap pointers. | [Differentiable Reviewer Evidence](differentiable_reviewer_evidence.md), [Differentiable Roadmap](differentiable_roadmap.md) |
