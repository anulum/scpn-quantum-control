...
- arbitrary quantum neural architectures beyond the bounded local phase-QNN classifier, its QNN-specific gradient verifier, its conformance, framework-agreement, and optimizer-baseline suites, and declared QSNN training routes;
