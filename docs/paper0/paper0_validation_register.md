...
The repeatable processing method is documented in
`docs/paper0/paper0_processing_methodology.md`. Future Book II papers should not be
marked as processed until they satisfy that methodology's completion standard.
