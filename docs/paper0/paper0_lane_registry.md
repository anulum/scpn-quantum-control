...
|---|---|---|---|---|
| `P0L01_front_matter_context` | `source_boundary_context` | `P0R00018 to P0R00104` | no_external_validation_submission, downstream_boundary_projection | paper/gotm_scpn_master_publications/gotm-scpn_paper-00_the_foundational_framework/source_validation_artifacts/paper0_front_matter_context_validation_specs_2026-05-13.json |
