...
`tools/test_typing_policy.json` is the machine-readable policy. The 546-file enforced cohort set
consists of the 20-file `repository_policy` cohort covering coverage,
...
entanglement-sync scientific and evidence slice, and the 91-file
...
tests, and the 433-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
