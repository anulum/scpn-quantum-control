...
`tools/test_typing_policy.json` is the machine-readable policy. The 697-file enforced cohort set
...
isolated-benchmark host-readiness gate, and the 100-file
...
tests, and the 567-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
