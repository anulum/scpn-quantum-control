...
`tools/test_typing_policy.json` is the machine-readable policy. The 615-file enforced cohort set
consists of the 26-file `repository_policy` cohort covering coverage,
...
tests, and the 492-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
