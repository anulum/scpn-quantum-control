...
`tools/test_typing_policy.json` is the machine-readable policy. The 588-file enforced cohort set
...
tests, and the 467-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
