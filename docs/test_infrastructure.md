...
`tools/test_typing_policy.json` is the machine-readable policy. The 470-file enforced cohort set
...
entanglement-sync scientific and evidence slice, and the 86-file
...
tests, and the 365-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
