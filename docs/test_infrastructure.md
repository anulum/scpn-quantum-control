...
`tools/test_typing_policy.json` is the machine-readable policy. The 386-file enforced cohort set
...
entanglement-sync scientific and evidence slice, and the 69-file
...
tests, and the 298-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
