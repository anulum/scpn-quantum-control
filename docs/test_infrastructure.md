...
`tools/test_typing_policy.json` is the machine-readable policy. The 583-file enforced cohort set
consists of the 24-file `repository_policy` cohort covering coverage,
...
entanglement-sync scientific and evidence slice, and the 95-file
...
tests, and the 462-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
