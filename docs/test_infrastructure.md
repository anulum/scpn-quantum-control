...
`tools/test_typing_policy.json` is the machine-readable policy. The 177-file enforced cohort set
...
tests, and the 119-file `scientific_runtime_contracts` cohort holding the whole
