...
`tools/test_typing_policy.json` is the machine-readable policy. The 349-file enforced cohort set
...
entanglement-sync scientific and evidence slice, and the 56-file
...
tests, and the 275-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
