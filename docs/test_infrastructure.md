...
`tools/test_typing_policy.json` is the machine-readable policy. The 395-file enforced cohort set
...
tests, and the 307-file `scientific_runtime_contracts` cohort holding the whole differentiable and phase
