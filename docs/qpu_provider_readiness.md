...
| Pulse-level control | Provider-specific and access-dependent; IBM QPUs ceased pulse-level access and Qiskit 2 removed `qiskit.pulse` | Legacy no-submit pulse-design schemas plus source-dated analog-mapping capability sketches; no current live pulse lane | Thinner — design-only, not an executable provider route |
...
- IQM Qiskit integration and fake backends:
  <https://github.com/iqm-finland/sdk/blob/main/docs/4.6/iqm-client/_sources/user_guide_qiskit.rst>,
  <https://github.com/iqm-finland/sdk/blob/main/docs/4.6/iqm-client/_sources/api/iqm.qiskit_iqm.fake_backends.rst>
