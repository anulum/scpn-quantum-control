...
| 8 | Benchmark oracle | Quantum Sync Challenge fixtures, baselines, leaderboard-ready output, CI-only benchmark evidence bundles, self-hosted `isolated-benchmark` runner setup, and isolated-affinity benchmark metadata gates. |
