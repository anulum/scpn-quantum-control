...
Strict scalar 2x2 determinant, zero-offset 2x2 trace, 2x2 inverse, and 2x2
linear solve program-AD nodes also lower to native LLVM/JIT arithmetic kernels;
wider linalg and shape-changing linalg traces still report unsupported native
