...
| Ansatz scaling | n=4--12 scaling rows and tensor-network truncation diagnostics are generated by the optional scaling harness. | `ansatz_scaling_tn_summary_2026-05-05.json` | Larger tensor-network rows remain bounded by the validated backend status in the artefact. |
