...
| Ansatz scaling | n=4--12 scaling rows and tensor-network truncation diagnostics are generated by the optional scaling harness. | `ansatz_scaling_tn_summary_2026-05-05.json` | Dense exact references cover small n; sparse eigensolver references extend the current promoted diagnostics where feasible. |
...
| Ansatz scaling plus tensor-network diagnostics | [`ansatz_scaling_tn_summary_2026-05-05.json`](https://github.com/anulum/scpn-quantum-control/blob/main/data/rust_vqe_methods/ansatz_scaling_tn_summary_2026-05-05.json) | [`benchmark_ansatz_scaling_tn.py`](https://github.com/anulum/scpn-quantum-control/blob/main/scripts/benchmark_ansatz_scaling_tn.py) |
...
| FIM sector survival | [`fim_sector_survival_summary_2026-05-05.json`](https://github.com/anulum/scpn-quantum-control/blob/main/data/scpn_fim_hamiltonian/fim_sector_survival_summary_2026-05-05.json) | [`analyse_fim_sector_survival.py`](https://github.com/anulum/scpn-quantum-control/blob/main/scripts/analyse_fim_sector_survival.py) |
...
The n=6--12 ansatz-scaling study records circuit scaling plus tensor-network
truncation diagnostics. The harness uses dense exact diagonalisation up to the
configured exact limit and sparse eigensolver ground states above that limit
where feasible. Rows beyond the configured sparse limit remain skipped rather
than extrapolated. Current outputs:
