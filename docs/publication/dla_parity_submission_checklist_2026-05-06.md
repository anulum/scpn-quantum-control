...
| Item | Path |
|------|------|
| Phase 2 package manifest | `docs/publication/publication_phase2_package_2026-05-05.md` |
| No-QPU cross-checks | `docs/campaigns/phase2_no_qpu_crosschecks_2026-05-05.md` |
| Hardware continuation protocol | `docs/campaigns/next_validation_protocols_2026-05-05.md` |
...
| Phase 3 state/layout manifest | `docs/campaigns/phase3_state_layout_dla_manifest_2026-05-07.md` |
| Paper source | `paper/submissions/submission_002_phase1_dla_parity/phase1_dla_parity.tex` |
| Paper PDF | `paper/submissions/submission_002_phase1_dla_parity/phase1_dla_parity.pdf` |
...
- Rebuild `paper/submissions/submission_002_phase1_dla_parity/phase1_dla_parity.pdf` from `paper/submissions/submission_002_phase1_dla_parity/phase1_dla_parity.tex`.
