...
| Item | Path |
|------|------|
| JOSS paper source | `paper/submissions_joss/submission_joss_001_software_framework_note/paper.md` |
| JOSS preview source | `paper/submissions_joss/submission_joss_001_software_framework_note/paper_preview.tex` |
| JOSS preview PDF | `paper/submissions_joss/submission_joss_001_software_framework_note/paper_preview.pdf` |
...
| DLA submission checklist | `docs/publication/dla_parity_submission_checklist_2026-05-06.md` |
| Rust/VQE submission checklist | `docs/publication/rust_vqe_methods_submission_checklist_2026-05-06.md` |
| Software artefacts | `data/rust_vqe_methods/` |
| Hardware validation package | `docs/publication/publication_phase2_package_2026-05-05.md` |
...
- Rebuild `paper/submissions_joss/submission_joss_001_software_framework_note/paper_preview.pdf` from `paper/submissions_joss/submission_joss_001_software_framework_note/paper_preview.tex`
  if the preview source changed.
- Verify `paper/submissions_joss/submission_joss_001_software_framework_note/paper.md` has valid YAML metadata and bibliography links.
- Verify every benchmark number in `paper/submissions_joss/submission_joss_001_software_framework_note/paper.md` appears in committed
