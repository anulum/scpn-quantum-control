...
DifferentiableOptimizer(learning_rate=0.01).step(values, gradient_result, bounds=None) -> np.ndarray
DifferentiableOptimizer(...).minimize(objective, initial_values, parameters=None, rule=None, gradient_method="parameter_shift", finite_difference_step=1e-6, bounds=None, max_steps=100, gradient_tolerance=1e-8, value_tolerance=None) -> OptimizationResult
