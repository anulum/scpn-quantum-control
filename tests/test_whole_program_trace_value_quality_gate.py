...
def test_coverage_gate_reuses_execution_and_covers_linalg_exactly() -> None:
    """Require shared real execution and exact trace/linalg coverage."""
    ...
    assert "*/program_ad_linalg_primitives.py" in report
