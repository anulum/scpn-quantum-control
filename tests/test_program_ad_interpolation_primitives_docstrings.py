...
# SCPN Quantum Control — program AD interpolation primitives docstrings tests
"""Documentation-layout tests for Program AD interpolation primitives."""
...
import scpn_quantum_control.program_ad_interpolation_primitives as interpolation
...
def test_program_ad_interpolation_primitives_have_no_post_docstring_blanks() -> None:
    """Interpolation primitive docstrings should follow the repository D202 contract."""
    source_path = Path(interpolation.__file__)
