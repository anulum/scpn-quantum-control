...
r"""Tests for :mod:`scpn_quantum_control.accel.kuramoto_simplex_mean_field`.
...
from scpn_quantum_control.accel.mean_phase_observables import mean_phase
from scpn_quantum_control.accel.order_parameter_observables import order_parameter
from scpn_quantum_control.accel.triadic_mean_field import (
