...
:mod:`scpn_quantum_control.accel.diff_kuramoto_delay_sensitivity` co-integrates a hand-derived
...
def _delayed_force(current: Array, lagged: Array, omega: Array, coupling: Array) -> Array:
    ...
    Mirrors :func:`scpn_quantum_control.accel.diff_kuramoto_delay_sensitivity._force` with
