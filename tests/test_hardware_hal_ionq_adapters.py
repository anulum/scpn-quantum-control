...
# SCPN Quantum Control — hardware HAL ionq adapters tests
...
def test_ionq_direct_adapter_normalises_provider_status_tokens() -> None:
    ...
    assert ionq_mod._normalise_status("ABORTING") == "cancelled"
    assert ionq_mod._normalise_status("CANCELLING") == "cancelled"
