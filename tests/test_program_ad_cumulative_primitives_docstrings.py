...
# SCPN Quantum Control — program AD cumulative primitives docstrings tests
"""Documentation-layout tests for Program AD cumulative primitives."""
...
import scpn_quantum_control.program_ad_cumulative_primitives as cumulative
...
def test_program_ad_cumulative_primitives_have_no_post_docstring_blanks() -> None:
    """Cumulative primitive docstrings should follow the repository D202 contract."""
    source_path = Path(cumulative.__file__)
