...
# scpn-quantum-control — Dynamical reproduction of a two-population Kuramoto–Sakaguchi chimera
...
the production Kuramoto–Sakaguchi force (:func:`~scpn_quantum_control.accel.sakaguchi_kuramoto.sakaguchi_force`,
...
from scpn_quantum_control.accel.kuramoto_chimera import chimera_index, community_order_parameters
