...
# scpn-quantum-control — Sakaguchi–Kuramoto mean-field force and Jacobian tests
...
import scpn_quantum_control.accel.sakaguchi_mean_field as smf
...
class TestSakaguchiMeanFieldTiersAndDispatch:
    ...
    def test_julia_matches_python_floor(self) -> None:
        ...
        from scpn_quantum_control.accel.julia import sakaguchi_mean_field_force as julia_force
