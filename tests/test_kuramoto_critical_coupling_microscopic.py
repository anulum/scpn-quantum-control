...
# scpn-quantum-control — Microscopic synchronisation-onset witness for the analytical critical coupling
...
(:func:`~scpn_quantum_control.accel.diff_kuramoto_rk4.kuramoto_rk4_trajectory`), and reads the
stationary Kuramoto order parameter with the production observable
(:func:`~scpn_quantum_control.accel.order_parameter_observables.order_parameter`) averaged over the
