...
r"""Tests for :mod:`scpn_quantum_control.accel.kuramoto_clusters`.
...
from scpn_quantum_control.accel.kuramoto_clusters import (
    ClusterPartition,
    cluster_count,
    cluster_partition,
    phase_clusters,
)
from scpn_quantum_control.accel.kuramoto_coherence_matrix import (
