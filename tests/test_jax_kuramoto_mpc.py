...
from scpn_quantum_control.accel import jax_kuramoto_mpc as mpc  # noqa: E402
from scpn_quantum_control.accel.kuramoto_network_control import (  # noqa: E402
    integrate_controlled_network,
    network_control_value_and_grad,
)
from scpn_quantum_control.accel.order_parameter_observables import order_parameter  # noqa: E402
...
def test_missing_jax_raises_import_error(monkeypatch: pytest.MonkeyPatch) -> None:
    def _raise() -> object:
        raise ImportError("the JAX MPC tier requires JAX; install scpn-quantum-control[jax]")
