...
# SCPN Quantum Control — program AD stencil primitives docstrings tests
"""Documentation-layout tests for Program AD stencil primitives."""
...
import scpn_quantum_control.program_ad_stencil_primitives as stencil
...
def test_program_ad_stencil_primitives_have_no_post_docstring_blanks() -> None:
    """Stencil primitive docstrings should follow the repository D202 contract."""
    source_path = Path(stencil.__file__)
