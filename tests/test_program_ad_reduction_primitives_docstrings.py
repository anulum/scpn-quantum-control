...
# SCPN Quantum Control — program AD reduction primitives docstrings tests
"""Documentation-layout tests for Program AD reduction primitives."""
...
import scpn_quantum_control.program_ad_reduction_primitives as reductions
...
def test_program_ad_reduction_primitives_have_no_post_docstring_blanks() -> None:
    """Reduction primitive docstrings should follow the repository D202 contract."""
    source_path = Path(reductions.__file__)
