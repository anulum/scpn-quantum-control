...
from scripts.run_paper0_section_15_layer_summary_table_3_2_the_dynamic_spine_the_unified_phase_dynamics_p0r02810_fixture import (
    render_report,
    write_outputs,
)


def test_run_section_15_layer_summary_table_3_2_the_dynamic_spine_the_unified_phase_dynamics_p0r02810_fixture_writes_json_and_report(
    tmp_path: Path,
) -> None:
    ...
    assert payload["source_ledger_span"] == ["P0R02810", "P0R02830"]
    assert payload["source_record_count"] == 21
    assert payload["component_count"] == 1
    assert payload["next_source_boundary"] == "P0R02831"
    assert (
