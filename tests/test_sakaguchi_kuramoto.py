...
# scpn-quantum-control — Kuramoto–Sakaguchi frustrated force and stability Jacobian tests
...
import scpn_quantum_control.accel.networked_kuramoto as nk
import scpn_quantum_control.accel.sakaguchi_kuramoto as sk
...
class TestJuliaSakaguchiTier:
    def test_julia_matches_python_floor(self) -> None:
        ...
        from scpn_quantum_control.accel.julia import sakaguchi_force as julia_force
        from scpn_quantum_control.accel.julia import sakaguchi_jacobian as julia_jacobian
