...
def test_live_rust_crate_records_threading_without_simd_promotion() -> None:
    ...
    # force and stability Jacobian, the Kuramoto interaction energy and its gradient, and
    # the Kuramoto–Sakaguchi frustrated force and stability Jacobian, and the network-local
    # order parameter and its Jacobian PyO3 exports.
    assert audit.pyfunction_count == 155
