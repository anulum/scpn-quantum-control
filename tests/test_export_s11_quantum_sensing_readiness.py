...
# SCPN Quantum Control — export s11 quantum sensing readiness tests
...
def test_s11_export_writes_json_and_markdown(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The real exporter writes blocked-claim JSON and Markdown artefacts."""
